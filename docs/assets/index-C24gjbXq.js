 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var gt;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(gt||(gt={}));const tv={debug:gt.DEBUG,verbose:gt.VERBOSE,info:gt.INFO,warn:gt.WARN,error:gt.ERROR,silent:gt.SILENT},nv=gt.INFO,iv={[gt.DEBUG]:"log",[gt.VERBOSE]:"log",[gt.INFO]:"info",[gt.WARN]:"warn",[gt.ERROR]:"error"},rv=(n,e,...t)=>{if(e<n.logLevel)return;const i=new Date().toISOString(),r=iv[e];if(r)console[r](`[${i}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class sv{constructor(e){this.name=e,this._logLevel=nv,this._logHandler=rv,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in gt))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?tv[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,gt.DEBUG,...e),this._logHandler(this,gt.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,gt.VERBOSE,...e),this._logHandler(this,gt.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,gt.INFO,...e),this._logHandler(this,gt.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,gt.WARN,...e),this._logHandler(this,gt.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,gt.ERROR,...e),this._logHandler(this,gt.ERROR,...e)}}const ov=(n,e)=>e.some(t=>n instanceof t);let nf,rf;function av(){return nf||(nf=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function lv(){return rf||(rf=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Od=new WeakMap,wl=new WeakMap,Bd=new WeakMap,wa=new WeakMap,Hc=new WeakMap;function cv(n){const e=new Promise((t,i)=>{const r=()=>{n.removeEventListener("success",s),n.removeEventListener("error",o)},s=()=>{t(Mi(n.result)),r()},o=()=>{i(n.error),r()};n.addEventListener("success",s),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&Od.set(t,n)}).catch(()=>{}),Hc.set(e,n),e}function uv(n){if(wl.has(n))return;const e=new Promise((t,i)=>{const r=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",o),n.removeEventListener("abort",o)},s=()=>{t(),r()},o=()=>{i(n.error||new DOMException("AbortError","AbortError")),r()};n.addEventListener("complete",s),n.addEventListener("error",o),n.addEventListener("abort",o)});wl.set(n,e)}let Cl={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return wl.get(n);if(e==="objectStoreNames")return n.objectStoreNames||Bd.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return Mi(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function fv(n){Cl=n(Cl)}function hv(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const i=n.call(Ca(this),e,...t);return Bd.set(i,e.sort?e.sort():[e]),Mi(i)}:lv().includes(n)?function(...e){return n.apply(Ca(this),e),Mi(Od.get(this))}:function(...e){return Mi(n.apply(Ca(this),e))}}function dv(n){return typeof n=="function"?hv(n):(n instanceof IDBTransaction&&uv(n),ov(n,av())?new Proxy(n,Cl):n)}function Mi(n){if(n instanceof IDBRequest)return cv(n);if(wa.has(n))return wa.get(n);const e=dv(n);return e!==n&&(wa.set(n,e),Hc.set(e,n)),e}const Ca=n=>Hc.get(n);function pv(n,e,{blocked:t,upgrade:i,blocking:r,terminated:s}={}){const o=indexedDB.open(n,e),a=Mi(o);return i&&o.addEventListener("upgradeneeded",l=>{i(Mi(o.result),l.oldVersion,l.newVersion,Mi(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),a.then(l=>{s&&l.addEventListener("close",()=>s()),r&&l.addEventListener("versionchange",c=>r(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const mv=["get","getKey","getAll","getAllKeys","count"],gv=["put","add","delete","clear"],Ra=new Map;function sf(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Ra.get(e))return Ra.get(e);const t=e.replace(/FromIndex$/,""),i=e!==t,r=gv.includes(t);if(!(t in(i?IDBIndex:IDBObjectStore).prototype)||!(r||mv.includes(t)))return;const s=async function(o,...a){const l=this.transaction(o,r?"readwrite":"readonly");let c=l.store;return i&&(c=c.index(a.shift())),(await Promise.all([c[t](...a),r&&l.done]))[0]};return Ra.set(e,s),s}fv(n=>({...n,get:(e,t,i)=>sf(e,t)||n.get(e,t,i),has:(e,t)=>!!sf(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _v{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(vv(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function vv(n){return n.getComponent()?.type==="VERSION"}const Rl="@firebase/app",of="0.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ii=new sv("@firebase/app"),xv="@firebase/app-compat",Sv="@firebase/analytics-compat",Mv="@firebase/analytics",yv="@firebase/app-check-compat",Ev="@firebase/app-check",bv="@firebase/auth",Tv="@firebase/auth-compat",Av="@firebase/database",wv="@firebase/data-connect",Cv="@firebase/database-compat",Rv="@firebase/functions",Pv="@firebase/functions-compat",Dv="@firebase/installations",Iv="@firebase/installations-compat",Lv="@firebase/messaging",Uv="@firebase/messaging-compat",Nv="@firebase/performance",Fv="@firebase/performance-compat",Ov="@firebase/remote-config",Bv="@firebase/remote-config-compat",kv="@firebase/storage",zv="@firebase/storage-compat",Hv="@firebase/firestore",Vv="@firebase/ai",Gv="@firebase/firestore-compat",Wv="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pl="[DEFAULT]",Xv={[Rl]:"fire-core",[xv]:"fire-core-compat",[Mv]:"fire-analytics",[Sv]:"fire-analytics-compat",[Ev]:"fire-app-check",[yv]:"fire-app-check-compat",[bv]:"fire-auth",[Tv]:"fire-auth-compat",[Av]:"fire-rtdb",[wv]:"fire-data-connect",[Cv]:"fire-rtdb-compat",[Rv]:"fire-fn",[Pv]:"fire-fn-compat",[Dv]:"fire-iid",[Iv]:"fire-iid-compat",[Lv]:"fire-fcm",[Uv]:"fire-fcm-compat",[Nv]:"fire-perf",[Fv]:"fire-perf-compat",[Ov]:"fire-rc",[Bv]:"fire-rc-compat",[kv]:"fire-gcs",[zv]:"fire-gcs-compat",[Hv]:"fire-fst",[Gv]:"fire-fst-compat",[Vv]:"fire-vertex","fire-js":"fire-js",[Wv]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const No=new Map,$v=new Map,Dl=new Map;function af(n,e){try{n.container.addComponent(e)}catch(t){ii.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Fo(n){const e=n.name;if(Dl.has(e))return ii.debug(`There were multiple attempts to register component ${e}.`),!1;Dl.set(e,n);for(const t of No.values())af(t,n);for(const t of $v.values())af(t,n);return!0}function qv(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Yv(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const e0=1024,t0=30;class n0{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new r0(t),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=cf();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(r=>r.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:t}),this._heartbeatsCache.heartbeats.length>t0){const r=s0(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){ii.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=cf(),{heartbeatsToSend:t,unsentEntries:i}=i0(this._heartbeatsCache.heartbeats),r=Id(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(e){return ii.warn(e),""}}}function cf(){return new Date().toISOString().substring(0,10)}function i0(n,e=e0){const t=[];let i=n.slice();for(const r of n){const s=t.find(o=>o.agent===r.agent);if(s){if(s.dates.push(r.date),uf(t)>e){s.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),uf(t)>e){t.pop();break}i=i.slice(1)}return{heartbeatsToSend:t,unsentEntries:i}}class r0{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return $_()?q_().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Qv(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return lf(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return lf(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function uf(n){return Id(JSON.stringify({version:2,heartbeats:n})).length}function s0(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let i=1;i<n.length;i++)n[i].date<t&&(t=n[i].date,e=i);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function o0(n){Fo(new ys("platform-logger",e=>new _v(e),"PRIVATE")),Fo(new ys("heartbeat",e=>new n0(e),"PRIVATE")),Dr(Rl,of,n),Dr(Rl,of,"esm2020"),Dr("fire-js","")}o0("");var a0="firebase",l0="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ff={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class Kt extends Hr{constructor(e,t,i){super(`${Vc}/${e}`,t||""),this.details=i,Object.setPrototypeOf(this,Kt.prototype)}}function f0(n){if(n>=200&&n<300)return"ok";switch(n){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function Bo(n,e){let t=f0(n),i=t,r;try{const s=e&&e.error;if(s){const o=s.status;if(typeof o=="string"){if(!ff[o])return new Kt("internal","internal");t=ff[o],i=o}const a=s.message;typeof a=="string"&&(i=a),r=s.details,r!==void 0&&(r=Nr(r))}}catch{}return t==="ok"?null:new Kt(t,i,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class h0{constructor(e,t,i,r){this.app=e,this.auth=null,this.messaging=null,this.appCheck=null,this.serverAppAppCheckToken=null,Yv(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.auth=t.getImmediate({optional:!0}),this.messaging=i.getImmediate({optional:!0}),this.auth||t.get().then(s=>this.auth=s,()=>{}),this.messaging||i.get().then(s=>this.messaging=s,()=>{}),this.appCheck||r?.get().then(s=>this.appCheck=s,()=>{})}async getAuthToken(){if(this.auth)try{return(await this.auth.getToken())?.accessToken}catch{return}}async getMessagingToken(){if(!(!this.messaging||!("Notification"in self)||Notification.permission!=="granted"))try{return await this.messaging.getToken()}catch{return}}async getAppCheckToken(e){if(this.serverAppAppCheckToken)return this.serverAppAppCheckToken;if(this.appCheck){const t=e?await this.appCheck.getLimitedUseToken():await this.appCheck.getToken();return t.error?null:t.token}return null}async getContext(e){const t=await this.getAuthToken(),i=await this.getMessagingToken(),r=await this.getAppCheckToken(e);return{authToken:t,messagingToken:i,appCheckToken:r}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Il="us-central1",d0=/^data: (.*?)(?:\n|$)/;function p0(n){let e=null;return{promise:new Promise((t,i)=>{e=setTimeout(()=>{i(new Kt("deadline-exceeded","deadline-exceeded"))},n)}),cancel:()=>{e&&clearTimeout(e)}}}class m0{constructor(e,t,i,r,s=Il,o=(...a)=>fetch(...a)){this.app=e,this.fetchImpl=o,this.emulatorOrigin=null,this.contextProvider=new h0(e,t,i,r),this.cancelAllRequests=new Promise(a=>{this.deleteService=()=>Promise.resolve(a())});try{const a=new URL(s);this.customDomain=a.origin+(a.pathname==="/"?"":a.pathname),this.region=Il}catch{this.customDomain=null,this.region=s}}_delete(){return this.deleteService()}_url(e){const t=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${t}/${this.region}/${e}`:this.customDomain!==null?`${this.customDomain}/${e}`:`https://${this.region}-${t}.cloudfunctions.net/${e}`}}function g0(n,e,t){const i=Nd(e);n.emulatorOrigin=`http${i?"s":""}://${e}:${t}`,i&&(V_(n.emulatorOrigin),X_("Functions",!0))}function _0(n,e,t){const i=r=>x0(n,e,r,{});return i.stream=(r,s)=>M0(n,e,r,s),i}async function v0(n,e,t,i){t["Content-Type"]="application/json";let r;try{r=await i(n,{method:"POST",body:JSON.stringify(e),headers:t})}catch{return{status:0,json:null}}let s=null;try{s=await r.json()}catch{}return{status:r.status,json:s}}async function Wd(n,e){const t={},i=await n.contextProvider.getContext(e.limitedUseAppCheckTokens);return i.authToken&&(t.Authorization="Bearer "+i.authToken),i.messagingToken&&(t["Firebase-Instance-ID-Token"]=i.messagingToken),i.appCheckToken!==null&&(t["X-Firebase-AppCheck"]=i.appCheckToken),t}function x0(n,e,t,i){const r=n._url(e);return S0(n,r,t,i)}async function S0(n,e,t,i){t=Oo(t);const r={data:t},s=await Wd(n,i),o=i.timeout||7e4,a=p0(o),l=await Promise.race([v0(e,r,s,n.fetchImpl),a.promise,n.cancelAllRequests]);if(a.cancel(),!l)throw new Kt("cancelled","Firebase Functions instance was deleted.");const c=Bo(l.status,l.json);if(c)throw c;if(!l.json)throw new Kt("internal","Response is not valid JSON object.");let u=l.json.data;if(typeof u>"u"&&(u=l.json.result),typeof u>"u")throw new Kt("internal","Response is missing data field.");return{data:Nr(u)}}function M0(n,e,t,i){const r=n._url(e);return y0(n,r,t,i||{})}async function y0(n,e,t,i){t=Oo(t);const r={data:t},s=await Wd(n,i);s["Content-Type"]="application/json",s.Accept="text/event-stream";let o;try{o=await n.fetchImpl(e,{method:"POST",body:JSON.stringify(r),headers:s,signal:i?.signal})}catch(h){if(h instanceof Error&&h.name==="AbortError"){const _=new Kt("cancelled","Request was cancelled.");return{data:Promise.reject(_),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(_)}}}}}}const p=Bo(0,null);return{data:Promise.reject(p),stream:{[Symbol.asyncIterator](){return{next(){return Promise.reject(p)}}}}}}let a,l;const c=new Promise((h,p)=>{a=h,l=p});i?.signal?.addEventListener("abort",()=>{const h=new Kt("cancelled","Request was cancelled.");l(h)});const u=o.body.getReader(),f=E0(u,a,l,i?.signal);return{stream:{[Symbol.asyncIterator](){const h=f.getReader();return{async next(){const{value:p,done:_}=await h.read();return{value:p,done:_}},async return(){return await h.cancel(),{done:!0,value:void 0}}}}},data:c}}function E0(n,e,t,i){const r=(o,a)=>{const l=o.match(d0);if(!l)return;const c=l[1];try{const u=JSON.parse(c);if("result"in u){e(Nr(u.result));return}if("message"in u){a.enqueue(Nr(u.message));return}if("error"in u){const f=Bo(0,u);a.error(f),t(f);return}}catch(u){if(u instanceof Kt){a.error(u),t(u);return}}},s=new TextDecoder;return new ReadableStream({start(o){let a="";return l();async function l(){if(i?.aborted){const c=new Kt("cancelled","Request was cancelled");return o.error(c),t(c),Promise.resolve()}try{const{value:c,done:u}=await n.read();if(u){a.trim()&&r(a.trim(),o),o.close();return}if(i?.aborted){const h=new Kt("cancelled","Request was cancelled");o.error(h),t(h),await n.cancel();return}a+=s.decode(c,{stream:!0});const f=a.split(`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const b0="auth-internal",T0="app-check-internal",A0="messaging-internal";function w0(n){const e=(t,{instanceIdentifier:i})=>{const r=t.getProvider("app").getImmediate(),s=t.getProvider(b0),o=t.getProvider(A0),a=t.getProvider(T0);return new m0(r,s,o,a,i)};Fo(new ys(Vc,e,"PUBLIC").setMultipleInstances(!0)),Dr(hf,df,n),Dr(hf,df,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
Please report this to https://github.com/markedjs/marked.`,n){let i="<p>An error occurred:</p><pre>"+An(t.message+"",!0)+"</pre>";return e?Promise.resolve(i):i}if(e)return Promise.reject(t);throw t}}},tr=new Px;function st(n,e){return tr.parse(n,e)}st.options=st.setOptions=function(n){return tr.setOptions(n),st.defaults=tr.defaults,$d(st.defaults),st};st.getDefaults=Gc;st.defaults=or;st.use=function(...n){return tr.use(...n),st.defaults=tr.defaults,$d(st.defaults),st};st.walkTokens=function(n,e){return tr.walkTokens(n,e)};st.parseInline=tr.parseInline;st.Parser=Jn;st.parser=Jn.parse;st.Renderer=Ho;st.TextRenderer=Zc;st.Lexer=Zn;st.lexer=Zn.lex;st.Tokenizer=zo;st.Hooks=xo;st.parse=st;st.options;st.setOptions;st.use;st.walkTokens;st.parseInline;Jn.parse;Zn.lex;const Dx=`# 🌐 Artificial Intelligence & Web Interfaces Expert – Multilingual
...
`,Ix=`# 🌐 Expert en Intelligence Artificielle & Interfaces Web – Multilingue
...
`)}function _T(n,e){let t;switch(e){case uS:t="Linear";break;case fS:t="Reinhard";break;case hS:t="Cineon";break;case dS:t="ACESFilmic";break;case mS:t="AgX";break;case gS:t="Neutral";break;case pS:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const fo=new B;function vT(){Ke.getLuminanceCoefficients(fo);const n=fo.x.toFixed(4),e=fo.y.toFixed(4),t=fo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function wT(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===ip?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Gx?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===$n&&(e="SHADOWMAP_TYPE_VSM"),e}function CT(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Or:case Br:e="ENVMAP_TYPE_CUBE";break;case la:e="ENVMAP_TYPE_CUBE_UV";break}return e}function RT(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Br:e="ENVMAP_MODE_REFRACTION";break}return e}function PT(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case rp:e="ENVMAP_BLENDING_MULTIPLY";break;case lS:e="ENVMAP_BLENDING_MIX";break;case cS:e="ENVMAP_BLENDING_ADD";break}return e}function DT(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function IT(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=wT(t),c=CT(t),u=RT(t),f=PT(t),h=DT(t),p=xT(t),_=ST(s),x=r.createProgram();let m,d,w=t.glslVersion?"#version "+t.glslVersion+`
