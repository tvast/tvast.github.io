...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function Sc(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const ft={},Ar=[],Dn=()=>{},Bp=()=>!1,Wo=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),yc=n=>n.startsWith("onUpdate:"),Rt=Object.assign,Mc=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},kp=Object.prototype.hasOwnProperty,et=(n,e)=>kp.call(n,e),Be=Array.isArray,wr=n=>Xo(n)==="[object Map]",_h=n=>Xo(n)==="[object Set]",Ve=n=>typeof n=="function",Et=n=>typeof n=="string",wi=n=>typeof n=="symbol",_t=n=>n!==null&&typeof n=="object",vh=n=>(_t(n)||Ve(n))&&Ve(n.then)&&Ve(n.catch),xh=Object.prototype.toString,Xo=n=>xh.call(n),zp=n=>Xo(n).slice(8,-1),Sh=n=>Xo(n)==="[object Object]",Ec=n=>Et(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,rs=Sc(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),$o=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},Hp=/-(\w)/g,dn=$o(n=>n.replace(Hp,(e,t)=>t?t.toUpperCase():"")),Vp=/\B([A-Z])/g,sr=$o(n=>n.replace(Vp,"-$1").toLowerCase()),qo=$o(n=>n.charAt(0).toUpperCase()+n.slice(1)),ha=$o(n=>n?`on${qo(n)}`:""),xi=(n,e)=>!Object.is(n,e),fo=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},cl=(n,e,t,i=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:i,value:t})},ul=n=>{const e=parseFloat(n);return isNaN(e)?n:e},Gp=n=>{const e=Et(n)?Number(n):NaN;return isNaN(e)?n:e};let pu;const Yo=()=>pu||(pu=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function bc(n){if(Be(n)){const e={};for(let t=0;t<n.length;t++){const i=n[t],r=Et(i)?qp(i):bc(i);if(r)for(const s in r)e[s]=r[s]}return e}else if(Et(n)||_t(n))return n}const Wp=/;(?![^(]*\))/g,Xp=/:([^]+)/,$p=/\/\*[^]*?\*\//g;function qp(n){const e={};return n.replace($p,"").split(Wp).forEach(t=>{if(t){const i=t.split(Xp);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function Tc(n){let e="";if(Et(n))e=n;else if(Be(n))for(let t=0;t<n.length;t++){const i=Tc(n[t]);i&&(e+=i+" ")}else if(_t(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const Yp="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",jp=Sc(Yp);function yh(n){return!!n||n===""}const Mh=n=>!!(n&&n.__v_isRef===!0),rn=n=>Et(n)?n:n==null?"":Be(n)||_t(n)&&(n.toString===xh||!Ve(n.toString))?Mh(n)?rn(n.value):JSON.stringify(n,Eh,2):String(n),Eh=(n,e)=>Mh(e)?Eh(n,e.value):wr(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[i,r],s)=>(t[da(i,s)+" =>"]=r,t),{})}:_h(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>da(t))}:wi(e)?da(e):_t(e)&&!Be(e)&&!Sh(e)?String(e):e,da=(n,e="")=>{var t;return wi(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let qt;class Kp{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=qt,!e&&qt&&(this.index=(qt.scopes||(qt.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=qt;try{return qt=this,e()}finally{qt=t}}}on(){++this._on===1&&(this.prevScope=qt,qt=this)}off(){this._on>0&&--this._on===0&&(qt=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let t,i;for(t=0,i=this.effects.length;t<i;t++)this.effects[t].stop();for(this.effects.length=0,t=0,i=this.cleanups.length;t<i;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,i=this.scopes.length;t<i;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0}}}function Zp(){return qt}let dt;const pa=new WeakSet;class bh{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,qt&&qt.active&&qt.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,pa.has(this)&&(pa.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Ah(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,mu(this),wh(this);const e=dt,t=xn;dt=this,xn=!0;try{return this.fn()}finally{Ch(this),dt=e,xn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)Cc(e);this.deps=this.depsTail=void 0,mu(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?pa.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){fl(this)&&this.run()}get dirty(){return fl(this)}}let Th=0,ss,os;function Ah(n,e=!1){if(n.flags|=8,e){n.next=os,os=n;return}n.next=ss,ss=n}function Ac(){Th++}function wc(){if(--Th>0)return;if(os){let e=os;for(os=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;ss;){let e=ss;for(ss=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(i){n||(n=i)}e=t}}if(n)throw n}function wh(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Ch(n){let e,t=n.depsTail,i=t;for(;i;){const r=i.prevDep;i.version===-1?(i===t&&(t=r),Cc(i),Jp(i)):e=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=r}n.deps=e,n.depsTail=t}function fl(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(Rh(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function Rh(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===ps)||(n.globalVersion=ps,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!fl(n))))return;n.flags|=2;const e=n.dep,t=dt,i=xn;dt=n,xn=!0;try{wh(n);const r=n.fn(n._value);(e.version===0||xi(r,n._value))&&(n.flags|=128,n._value=r,e.version++)}catch(r){throw e.version++,r}finally{dt=t,xn=i,Ch(n),n.flags&=-3}}function Cc(n,e=!1){const{dep:t,prevSub:i,nextSub:r}=n;if(i&&(i.nextSub=r,n.prevSub=void 0),r&&(r.prevSub=i,n.nextSub=void 0),t.subs===n&&(t.subs=i,!i&&t.computed)){t.computed.flags&=-5;for(let s=t.computed.deps;s;s=s.nextDep)Cc(s,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function Jp(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let xn=!0;const Ph=[];function ei(){Ph.push(xn),xn=!1}function ti(){const n=Ph.pop();xn=n===void 0?!0:n}function mu(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=dt;dt=void 0;try{e()}finally{dt=t}}}let ps=0;class Qp{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Rc{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!dt||!xn||dt===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==dt)t=this.activeLink=new Qp(dt,this),dt.deps?(t.prevDep=dt.depsTail,dt.depsTail.nextDep=t,dt.depsTail=t):dt.deps=dt.depsTail=t,Dh(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const i=t.nextDep;i.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=i),t.prevDep=dt.depsTail,t.nextDep=void 0,dt.depsTail.nextDep=t,dt.depsTail=t,dt.deps===t&&(dt.deps=i)}return t}trigger(e){this.version++,ps++,this.notify(e)}notify(e){Ac();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{wc()}}}function Dh(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let i=e.deps;i;i=i.nextDep)Dh(i)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const hl=new WeakMap,tr=Symbol(""),dl=Symbol(""),ms=Symbol("");function Lt(n,e,t){if(xn&&dt){let i=hl.get(n);i||hl.set(n,i=new Map);let r=i.get(t);r||(i.set(t,r=new Rc),r.map=i,r.key=t),r.track()}}function $n(n,e,t,i,r,s){const o=hl.get(n);if(!o){ps++;return}const a=l=>{l&&l.trigger()};if(Ac(),e==="clear")o.forEach(a);else{const l=Be(n),c=l&&Ec(t);if(l&&t==="length"){const u=Number(i);o.forEach((f,h)=>{(h==="length"||h===ms||!wi(h)&&h>=u)&&a(f)})}else switch((t!==void 0||o.has(void 0))&&a(o.get(t)),c&&a(o.get(ms)),e){case"add":l?c&&a(o.get("length")):(a(o.get(tr)),wr(n)&&a(o.get(dl)));break;case"delete":l||(a(o.get(tr)),wr(n)&&a(o.get(dl)));break;case"set":wr(n)&&a(o.get(tr));break}}wc()}function lr(n){const e=Ke(n);return e===n?e:(Lt(e,"iterate",ms),hn(n)?e:e.map(Ct))}function jo(n){return Lt(n=Ke(n),"iterate",ms),n}const em={__proto__:null,[Symbol.iterator](){return ma(this,Symbol.iterator,Ct)},concat(...n){return lr(this).concat(...n.map(e=>Be(e)?lr(e):e))},entries(){return ma(this,"entries",n=>(n[1]=Ct(n[1]),n))},every(n,e){return Fn(this,"every",n,e,void 0,arguments)},filter(n,e){return Fn(this,"filter",n,e,t=>t.map(Ct),arguments)},find(n,e){return Fn(this,"find",n,e,Ct,arguments)},findIndex(n,e){return Fn(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return Fn(this,"findLast",n,e,Ct,arguments)},findLastIndex(n,e){return Fn(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return Fn(this,"forEach",n,e,void 0,arguments)},includes(...n){return ga(this,"includes",n)},indexOf(...n){return ga(this,"indexOf",n)},join(n){return lr(this).join(n)},lastIndexOf(...n){return ga(this,"lastIndexOf",n)},map(n,e){return Fn(this,"map",n,e,void 0,arguments)},pop(){return $r(this,"pop")},push(...n){return $r(this,"push",n)},reduce(n,...e){return gu(this,"reduce",n,e)},reduceRight(n,...e){return gu(this,"reduceRight",n,e)},shift(){return $r(this,"shift")},some(n,e){return Fn(this,"some",n,e,void 0,arguments)},splice(...n){return $r(this,"splice",n)},toReversed(){return lr(this).toReversed()},toSorted(n){return lr(this).toSorted(n)},toSpliced(...n){return lr(this).toSpliced(...n)},unshift(...n){return $r(this,"unshift",n)},values(){return ma(this,"values",Ct)}};function ma(n,e,t){const i=jo(n),r=i[e]();return i!==n&&!hn(n)&&(r._next=r.next,r.next=()=>{const s=r._next();return s.value&&(s.value=t(s.value)),s}),r}const tm=Array.prototype;function Fn(n,e,t,i,r,s){const o=jo(n),a=o!==n&&!hn(n),l=o[e];if(l!==tm[e]){const f=l.apply(n,s);return a?Ct(f):f}let c=t;o!==n&&(a?c=function(f,h){return t.call(this,Ct(f),h,n)}:t.length>2&&(c=function(f,h){return t.call(this,f,h,n)}));const u=l.call(o,c,i);return a&&r?r(u):u}function gu(n,e,t,i){const r=jo(n);let s=t;return r!==n&&(hn(n)?t.length>3&&(s=function(o,a,l){return t.call(this,o,a,l,n)}):s=function(o,a,l){return t.call(this,o,Ct(a),l,n)}),r[e](s,...i)}function ga(n,e,t){const i=Ke(n);Lt(i,"iterate",ms);const r=i[e](...t);return(r===-1||r===!1)&&Ic(t[0])?(t[0]=Ke(t[0]),i[e](...t)):r}function $r(n,e,t=[]){ei(),Ac();const i=Ke(n)[e].apply(n,t);return wc(),ti(),i}const nm=Sc("__proto__,__v_isRef,__isVue"),Ih=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(wi));function im(n){wi(n)||(n=String(n));const e=Ke(this);return Lt(e,"has",n),e.hasOwnProperty(n)}class Lh{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,i){if(t==="__v_skip")return e.__v_skip;const r=this._isReadonly,s=this._isShallow;if(t==="__v_isReactive")return!r;if(t==="__v_isReadonly")return r;if(t==="__v_isShallow")return s;if(t==="__v_raw")return i===(r?s?dm:Oh:s?Fh:Nh).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(i)?e:void 0;const o=Be(e);if(!r){let l;if(o&&(l=em[t]))return l;if(t==="hasOwnProperty")return im}const a=Reflect.get(e,t,Ft(e)?e:i);return(wi(t)?Ih.has(t):nm(t))||(r||Lt(e,"get",t),s)?a:Ft(a)?o&&Ec(t)?a:a.value:_t(a)?r?Bh(a):Ko(a):a}}class Uh extends Lh{constructor(e=!1){super(!1,e)}set(e,t,i,r){let s=e[t];if(!this._isShallow){const l=bi(s);if(!hn(i)&&!bi(i)&&(s=Ke(s),i=Ke(i)),!Be(e)&&Ft(s)&&!Ft(i))return l?!1:(s.value=i,!0)}const o=Be(e)&&Ec(t)?Number(t)<e.length:et(e,t),a=Reflect.set(e,t,i,Ft(e)?e:r);return e===Ke(r)&&(o?xi(i,s)&&$n(e,"set",t,i):$n(e,"add",t,i)),a}deleteProperty(e,t){const i=et(e,t);e[t];const r=Reflect.deleteProperty(e,t);return r&&i&&$n(e,"delete",t,void 0),r}has(e,t){const i=Reflect.has(e,t);return(!wi(t)||!Ih.has(t))&&Lt(e,"has",t),i}ownKeys(e){return Lt(e,"iterate",Be(e)?"length":tr),Reflect.ownKeys(e)}}class rm extends Lh{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const sm=new Uh,om=new rm,am=new Uh(!0);const pl=n=>n,Os=n=>Reflect.getPrototypeOf(n);function lm(n,e,t){return function(...i){const r=this.__v_raw,s=Ke(r),o=wr(s),a=n==="entries"||n===Symbol.iterator&&o,l=n==="keys"&&o,c=r[n](...i),u=t?pl:e?Ao:Ct;return!e&&Lt(s,"iterate",l?dl:tr),{next(){const{value:f,done:h}=c.next();return h?{value:f,done:h}:{value:a?[u(f[0]),u(f[1])]:u(f),done:h}},[Symbol.iterator](){return this}}}}function Bs(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function cm(n,e){const t={get(r){const s=this.__v_raw,o=Ke(s),a=Ke(r);n||(xi(r,a)&&Lt(o,"get",r),Lt(o,"get",a));const{has:l}=Os(o),c=e?pl:n?Ao:Ct;if(l.call(o,r))return c(s.get(r));if(l.call(o,a))return c(s.get(a));s!==o&&s.get(r)},get size(){const r=this.__v_raw;return!n&&Lt(Ke(r),"iterate",tr),Reflect.get(r,"size",r)},has(r){const s=this.__v_raw,o=Ke(s),a=Ke(r);return n||(xi(r,a)&&Lt(o,"has",r),Lt(o,"has",a)),r===a?s.has(r):s.has(r)||s.has(a)},forEach(r,s){const o=this,a=o.__v_raw,l=Ke(a),c=e?pl:n?Ao:Ct;return!n&&Lt(l,"iterate",tr),a.forEach((u,f)=>r.call(s,c(u),c(f),o))}};return Rt(t,n?{add:Bs("add"),set:Bs("set"),delete:Bs("delete"),clear:Bs("clear")}:{add(r){!e&&!hn(r)&&!bi(r)&&(r=Ke(r));const s=Ke(this);return Os(s).has.call(s,r)||(s.add(r),$n(s,"add",r,r)),this},set(r,s){!e&&!hn(s)&&!bi(s)&&(s=Ke(s));const o=Ke(this),{has:a,get:l}=Os(o);let c=a.call(o,r);c||(r=Ke(r),c=a.call(o,r));const u=l.call(o,r);return o.set(r,s),c?xi(s,u)&&$n(o,"set",r,s):$n(o,"add",r,s),this},delete(r){const s=Ke(this),{has:o,get:a}=Os(s);let l=o.call(s,r);l||(r=Ke(r),l=o.call(s,r)),a&&a.call(s,r);const c=s.delete(r);return l&&$n(s,"delete",r,void 0),c},clear(){const r=Ke(this),s=r.size!==0,o=r.clear();return s&&$n(r,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=lm(r,n,e)}),t}function Pc(n,e){const t=cm(n,e);return(i,r,s)=>r==="__v_isReactive"?!n:r==="__v_isReadonly"?n:r==="__v_raw"?i:Reflect.get(et(t,r)&&r in i?t:i,r,s)}const um={get:Pc(!1,!1)},fm={get:Pc(!1,!0)},hm={get:Pc(!0,!1)};const Nh=new WeakMap,Fh=new WeakMap,Oh=new WeakMap,dm=new WeakMap;function pm(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function mm(n){return n.__v_skip||!Object.isExtensible(n)?0:pm(zp(n))}function Ko(n){return bi(n)?n:Dc(n,!1,sm,um,Nh)}function gm(n){return Dc(n,!1,am,fm,Fh)}function Bh(n){return Dc(n,!0,om,hm,Oh)}function Dc(n,e,t,i,r){if(!_t(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const s=mm(n);if(s===0)return n;const o=r.get(n);if(o)return o;const a=new Proxy(n,s===2?i:t);return r.set(n,a),a}function Cr(n){return bi(n)?Cr(n.__v_raw):!!(n&&n.__v_isReactive)}function bi(n){return!!(n&&n.__v_isReadonly)}function hn(n){return!!(n&&n.__v_isShallow)}function Ic(n){return n?!!n.__v_raw:!1}function Ke(n){const e=n&&n.__v_raw;return e?Ke(e):n}function _m(n){return!et(n,"__v_skip")&&Object.isExtensible(n)&&cl(n,"__v_skip",!0),n}const Ct=n=>_t(n)?Ko(n):n,Ao=n=>_t(n)?Bh(n):n;function Ft(n){return n?n.__v_isRef===!0:!1}function Ht(n){return vm(n,!1)}function vm(n,e){return Ft(n)?n:new xm(n,e)}class xm{constructor(e,t){this.dep=new Rc,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:Ke(e),this._value=t?e:Ct(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,i=this.__v_isShallow||hn(e)||bi(e);e=i?e:Ke(e),xi(e,t)&&(this._rawValue=e,this._value=i?e:Ct(e),this.dep.trigger())}}function kh(n){return Ft(n)?n.value:n}const Sm={get:(n,e,t)=>e==="__v_raw"?n:kh(Reflect.get(n,e,t)),set:(n,e,t,i)=>{const r=n[e];return Ft(r)&&!Ft(t)?(r.value=t,!0):Reflect.set(n,e,t,i)}};function zh(n){return Cr(n)?n:new Proxy(n,Sm)}class ym{constructor(e,t,i){this.fn=e,this.setter=t,this._value=void 0,this.dep=new Rc(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=ps-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&dt!==this)return Ah(this,!0),!0}get value(){const e=this.dep.track();return Rh(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function Mm(n,e,t=!1){let i,r;return Ve(n)?i=n:(i=n.get,r=n.set),new ym(i,r,t)}const ks={},wo=new WeakMap;let $i;function Em(n,e=!1,t=$i){if(t){let i=wo.get(t);i||wo.set(t,i=[]),i.push(n)}}function bm(n,e,t=ft){const{immediate:i,deep:r,once:s,scheduler:o,augmentJob:a,call:l}=t,c=S=>r?S:hn(S)||r===!1||r===0?qn(S,1):qn(S);let u,f,h,p,_=!1,x=!1;if(Ft(n)?(f=()=>n.value,_=hn(n)):Cr(n)?(f=()=>c(n),_=!0):Be(n)?(x=!0,_=n.some(S=>Cr(S)||hn(S)),f=()=>n.map(S=>{if(Ft(S))return S.value;if(Cr(S))return c(S);if(Ve(S))return l?l(S,2):S()})):Ve(n)?e?f=l?()=>l(n,2):n:f=()=>{if(h){ei();try{h()}finally{ti()}}const S=$i;$i=u;try{return l?l(n,3,[p]):n(p)}finally{$i=S}}:f=Dn,e&&r){const S=f,R=r===!0?1/0:r;f=()=>qn(S(),R)}const m=Zp(),d=()=>{u.stop(),m&&m.active&&Mc(m.effects,u)};if(s&&e){const S=e;e=(...R)=>{S(...R),d()}}let w=x?new Array(n.length).fill(ks):ks;const T=S=>{if(!(!(u.flags&1)||!u.dirty&&!S))if(e){const R=u.run();if(r||_||(x?R.some((D,P)=>xi(D,w[P])):xi(R,w))){h&&h();const D=$i;$i=u;try{const P=[R,w===ks?void 0:x&&w[0]===ks?[]:w,p];w=R,l?l(e,3,P):e(...P)}finally{$i=D}}}else u.run()};return a&&a(T),u=new bh(f),u.scheduler=o?()=>o(T,!1):T,p=S=>Em(S,!1,u),h=u.onStop=()=>{const S=wo.get(u);if(S){if(l)l(S,4);else for(const R of S)R();wo.delete(u)}},e?i?T(!0):w=u.run():o?o(T.bind(null,!0),!0):u.run(),d.pause=u.pause.bind(u),d.resume=u.resume.bind(u),d.stop=d,d}function qn(n,e=1/0,t){if(e<=0||!_t(n)||n.__v_skip||(t=t||new Set,t.has(n)))return n;if(t.add(n),e--,Ft(n))qn(n.value,e,t);else if(Be(n))for(let i=0;i<n.length;i++)qn(n[i],e,t);else if(_h(n)||wr(n))n.forEach(i=>{qn(i,e,t)});else if(Sh(n)){for(const i in n)qn(n[i],e,t);for(const i of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,i)&&qn(n[i],e,t)}return n}/**
* @vue/runtime-core v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Cs(n,e,t,i){try{return i?n(...i):n()}catch(r){Zo(r,e,t)}}function yn(n,e,t,i){if(Ve(n)){const r=Cs(n,e,t,i);return r&&vh(r)&&r.catch(s=>{Zo(s,e,t)}),r}if(Be(n)){const r=[];for(let s=0;s<n.length;s++)r.push(yn(n[s],e,t,i));return r}}function Zo(n,e,t,i=!0){const r=e?e.vnode:null,{errorHandler:s,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||ft;if(e){let a=e.parent;const l=e.proxy,c=`https://vuejs.org/error-reference/#runtime-${t}`;for(;a;){const u=a.ec;if(u){for(let f=0;f<u.length;f++)if(u[f](n,l,c)===!1)return}a=a.parent}if(s){ei(),Cs(s,null,10,[n,l,c]),ti();return}}Tm(n,t,r,i,o)}function Tm(n,e,t,i=!0,r=!1){if(r)throw n;console.error(n)}const Vt=[];let Tn=-1;const Rr=[];let mi=null,Er=0;const Hh=Promise.resolve();let Co=null;function Vh(n){const e=Co||Hh;return n?e.then(this?n.bind(this):n):e}function Am(n){let e=Tn+1,t=Vt.length;for(;e<t;){const i=e+t>>>1,r=Vt[i],s=gs(r);s<n||s===n&&r.flags&2?e=i+1:t=i}return e}function Lc(n){if(!(n.flags&1)){const e=gs(n),t=Vt[Vt.length-1];!t||!(n.flags&2)&&e>=gs(t)?Vt.push(n):Vt.splice(Am(e),0,n),n.flags|=1,Gh()}}function Gh(){Co||(Co=Hh.then(Xh))}function wm(n){Be(n)?Rr.push(...n):mi&&n.id===-1?mi.splice(Er+1,0,n):n.flags&1||(Rr.push(n),n.flags|=1),Gh()}function _u(n,e,t=Tn+1){for(;t<Vt.length;t++){const i=Vt[t];if(i&&i.flags&2){if(n&&i.id!==n.uid)continue;Vt.splice(t,1),t--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function Wh(n){if(Rr.length){const e=[...new Set(Rr)].sort((t,i)=>gs(t)-gs(i));if(Rr.length=0,mi){mi.push(...e);return}for(mi=e,Er=0;Er<mi.length;Er++){const t=mi[Er];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}mi=null,Er=0}}const gs=n=>n.id==null?n.flags&2?-1:1/0:n.id;function Xh(n){try{for(Tn=0;Tn<Vt.length;Tn++){const e=Vt[Tn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),Cs(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Tn<Vt.length;Tn++){const e=Vt[Tn];e&&(e.flags&=-2)}Tn=-1,Vt.length=0,Wh(),Co=null,(Vt.length||Rr.length)&&Xh()}}let sn=null,$h=null;function Ro(n){const e=sn;return sn=n,$h=n&&n.type.__scopeId||null,e}function as(n,e=sn,t){if(!e||n._n)return n;const i=(...r)=>{i._d&&Ru(-1);const s=Ro(e);let o;try{o=n(...r)}finally{Ro(s),i._d&&Ru(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function Cm(n,e){if(sn===null)return n;const t=ia(sn),i=n.dirs||(n.dirs=[]);for(let r=0;r<e.length;r++){let[s,o,a,l=ft]=e[r];s&&(Ve(s)&&(s={mounted:s,updated:s}),s.deep&&qn(o),i.push({dir:s,instance:t,value:o,oldValue:void 0,arg:a,modifiers:l}))}return n}function Ii(n,e,t,i){const r=n.dirs,s=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];s&&(a.oldValue=s[o].value);let l=a.dir[i];l&&(ei(),yn(l,t,8,[n.el,a,n,e]),ti())}}const Rm=Symbol("_vte"),qh=n=>n.__isTeleport,gi=Symbol("_leaveCb"),zs=Symbol("_enterCb");function Pm(){const n={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ci(()=>{n.isMounted=!0}),ea(()=>{n.isUnmounting=!0}),n}const cn=[Function,Array],Yh={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:cn,onEnter:cn,onAfterEnter:cn,onEnterCancelled:cn,onBeforeLeave:cn,onLeave:cn,onAfterLeave:cn,onLeaveCancelled:cn,onBeforeAppear:cn,onAppear:cn,onAfterAppear:cn,onAppearCancelled:cn},jh=n=>{const e=n.subTree;return e.component?jh(e.component):e},Dm={name:"BaseTransition",props:Yh,setup(n,{slots:e}){const t=yd(),i=Pm();return()=>{const r=e.default&&Jh(e.default(),!0);if(!r||!r.length)return;const s=Kh(r),o=Ke(n),{mode:a}=o;if(i.isLeaving)return _a(s);const l=vu(s);if(!l)return _a(s);let c=ml(l,o,i,t,f=>c=f);l.type!==Gt&&_s(l,c);let u=t.subTree&&vu(t.subTree);if(u&&u.type!==Gt&&!Ki(l,u)&&jh(t).type!==Gt){let f=ml(u,o,i,t);if(_s(u,f),a==="out-in"&&l.type!==Gt)return i.isLeaving=!0,f.afterLeave=()=>{i.isLeaving=!1,t.job.flags&8||t.update(),delete f.afterLeave,u=void 0},_a(s);a==="in-out"&&l.type!==Gt?f.delayLeave=(h,p,_)=>{const x=Zh(i,u);x[String(u.key)]=u,h[gi]=()=>{p(),h[gi]=void 0,delete c.delayedLeave,u=void 0},c.delayedLeave=()=>{_(),delete c.delayedLeave,u=void 0}}:u=void 0}else u&&(u=void 0);return s}}};function Kh(n){let e=n[0];if(n.length>1){for(const t of n)if(t.type!==Gt){e=t;break}}return e}const Im=Dm;function Zh(n,e){const{leavingVNodes:t}=n;let i=t.get(e.type);return i||(i=Object.create(null),t.set(e.type,i)),i}function ml(n,e,t,i,r){const{appear:s,mode:o,persisted:a=!1,onBeforeEnter:l,onEnter:c,onAfterEnter:u,onEnterCancelled:f,onBeforeLeave:h,onLeave:p,onAfterLeave:_,onLeaveCancelled:x,onBeforeAppear:m,onAppear:d,onAfterAppear:w,onAppearCancelled:T}=e,S=String(n.key),R=Zh(t,n),D=(E,b)=>{E&&yn(E,i,9,b)},P=(E,b)=>{const C=b[1];D(E,b),Be(E)?E.every(O=>O.length<=1)&&C():E.length<=1&&C()},U={mode:o,persisted:a,beforeEnter(E){let b=l;if(!t.isMounted)if(s)b=m||l;else return;E[gi]&&E[gi](!0);const C=R[S];C&&Ki(n,C)&&C.el[gi]&&C.el[gi](),D(b,[E])},enter(E){let b=c,C=u,O=f;if(!t.isMounted)if(s)b=d||c,C=w||u,O=T||f;else return;let W=!1;const K=E[zs]=ne=>{W||(W=!0,ne?D(O,[E]):D(C,[E]),U.delayedLeave&&U.delayedLeave(),E[zs]=void 0)};b?P(b,[E,K]):K()},leave(E,b){const C=String(n.key);if(E[zs]&&E[zs](!0),t.isUnmounting)return b();D(h,[E]);let O=!1;const W=E[gi]=K=>{O||(O=!0,b(),K?D(x,[E]):D(_,[E]),E[gi]=void 0,R[C]===n&&delete R[C])};R[C]=n,p?P(p,[E,W]):W()},clone(E){const b=ml(E,e,t,i,r);return r&&r(b),b}};return U}function _a(n){if(Jo(n))return n=Ti(n),n.children=null,n}function vu(n){if(!Jo(n))return qh(n.type)&&n.children?Kh(n.children):n;if(n.component)return n.component.subTree;const{shapeFlag:e,children:t}=n;if(t){if(e&16)return t[0];if(e&32&&Ve(t.default))return t.default()}}function _s(n,e){n.shapeFlag&6&&n.component?(n.transition=e,_s(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function Jh(n,e=!1,t){let i=[],r=0;for(let s=0;s<n.length;s++){let o=n[s];const a=t==null?o.key:String(t)+String(o.key!=null?o.key:s);o.type===Ut?(o.patchFlag&128&&r++,i=i.concat(Jh(o.children,e,a))):(e||o.type!==Gt)&&i.push(a!=null?Ti(o,{key:a}):o)}if(r>1)for(let s=0;s<i.length;s++)i[s].patchFlag=-2;return i}function Qh(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function ls(n,e,t,i,r=!1){if(Be(n)){n.forEach((_,x)=>ls(_,e&&(Be(e)?e[x]:e),t,i,r));return}if(cs(i)&&!r){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&ls(n,e,t,i.component.subTree);return}const s=i.shapeFlag&4?ia(i.component):i.el,o=r?null:s,{i:a,r:l}=n,c=e&&e.r,u=a.refs===ft?a.refs={}:a.refs,f=a.setupState,h=Ke(f),p=f===ft?()=>!1:_=>et(h,_);if(c!=null&&c!==l&&(Et(c)?(u[c]=null,p(c)&&(f[c]=null)):Ft(c)&&(c.value=null)),Ve(l))Cs(l,a,12,[o,u]);else{const _=Et(l),x=Ft(l);if(_||x){const m=()=>{if(n.f){const d=_?p(l)?f[l]:u[l]:l.value;r?Be(d)&&Mc(d,s):Be(d)?d.includes(s)||d.push(s):_?(u[l]=[s],p(l)&&(f[l]=u[l])):(l.value=[s],n.k&&(u[n.k]=l.value))}else _?(u[l]=o,p(l)&&(f[l]=o)):x&&(l.value=o,n.k&&(u[n.k]=o))};o?(m.id=-1,tn(m,t)):m()}}}Yo().requestIdleCallback;Yo().cancelIdleCallback;const cs=n=>!!n.type.__asyncLoader,Jo=n=>n.type.__isKeepAlive;function Lm(n,e){ed(n,"a",e)}function Um(n,e){ed(n,"da",e)}function ed(n,e,t=Nt){const i=n.__wdc||(n.__wdc=()=>{let r=t;for(;r;){if(r.isDeactivated)return;r=r.parent}return n()});if(Qo(e,i,t),t){let r=t.parent;for(;r&&r.parent;)Jo(r.parent.vnode)&&Nm(i,e,t,r),r=r.parent}}function Nm(n,e,t,i){const r=Qo(e,n,i,!0);td(()=>{Mc(i[e],r)},t)}function Qo(n,e,t=Nt,i=!1){if(t){const r=t[n]||(t[n]=[]),s=e.__weh||(e.__weh=(...o)=>{ei();const a=Rs(t),l=yn(e,t,n,o);return a(),ti(),l});return i?r.unshift(s):r.push(s),s}}const si=n=>(e,t=Nt)=>{(!Ss||n==="sp")&&Qo(n,(...i)=>e(...i),t)},Fm=si("bm"),Ci=si("m"),Om=si("bu"),Bm=si("u"),ea=si("bum"),td=si("um"),km=si("sp"),zm=si("rtg"),Hm=si("rtc");function Vm(n,e=Nt){Qo("ec",n,e)}const Gm="components";function xu(n,e){return Xm(Gm,n,!0,e)||n}const Wm=Symbol.for("v-ndc");function Xm(n,e,t=!0,i=!1){const r=sn||Nt;if(r){const s=r.type;{const a=Lg(s,!1);if(a&&(a===e||a===dn(e)||a===qo(dn(e))))return s}const o=Su(r[n]||s[n],e)||Su(r.appContext[n],e);return!o&&i?s:o}}function Su(n,e){return n&&(n[e]||n[dn(e)]||n[qo(dn(e))])}function Po(n,e,t,i){let r;const s=t,o=Be(n);if(o||Et(n)){const a=o&&Cr(n);let l=!1,c=!1;a&&(l=!hn(n),c=bi(n),n=jo(n)),r=new Array(n.length);for(let u=0,f=n.length;u<f;u++)r[u]=e(l?c?Ao(Ct(n[u])):Ct(n[u]):n[u],u,void 0,s)}else if(typeof n=="number"){r=new Array(n);for(let a=0;a<n;a++)r[a]=e(a+1,a,void 0,s)}else if(_t(n))if(n[Symbol.iterator])r=Array.from(n,(a,l)=>e(a,l,void 0,s));else{const a=Object.keys(n);r=new Array(a.length);for(let l=0,c=a.length;l<c;l++){const u=a[l];r[l]=e(n[u],u,l,s)}}else r=[];return r}const gl=n=>n?Md(n)?ia(n):gl(n.parent):null,us=Rt(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>gl(n.parent),$root:n=>gl(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>id(n),$forceUpdate:n=>n.f||(n.f=()=>{Lc(n.update)}),$nextTick:n=>n.n||(n.n=Vh.bind(n.proxy)),$watch:n=>dg.bind(n)}),va=(n,e)=>n!==ft&&!n.__isScriptSetup&&et(n,e),$m={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:i,data:r,props:s,accessCache:o,type:a,appContext:l}=n;let c;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return i[e];case 2:return r[e];case 4:return t[e];case 3:return s[e]}else{if(va(i,e))return o[e]=1,i[e];if(r!==ft&&et(r,e))return o[e]=2,r[e];if((c=n.propsOptions[0])&&et(c,e))return o[e]=3,s[e];if(t!==ft&&et(t,e))return o[e]=4,t[e];_l&&(o[e]=0)}}const u=us[e];let f,h;if(u)return e==="$attrs"&&Lt(n.attrs,"get",""),u(n);if((f=a.__cssModules)&&(f=f[e]))return f;if(t!==ft&&et(t,e))return o[e]=4,t[e];if(h=l.config.globalProperties,et(h,e))return h[e]},set({_:n},e,t){const{data:i,setupState:r,ctx:s}=n;return va(r,e)?(r[e]=t,!0):i!==ft&&et(i,e)?(i[e]=t,!0):et(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(s[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:i,appContext:r,propsOptions:s}},o){let a;return!!t[o]||n!==ft&&et(n,o)||va(e,o)||(a=s[0])&&et(a,o)||et(i,o)||et(us,o)||et(r.config.globalProperties,o)},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:et(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function yu(n){return Be(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let _l=!0;function qm(n){const e=id(n),t=n.proxy,i=n.ctx;_l=!1,e.beforeCreate&&Mu(e.beforeCreate,n,"bc");const{data:r,computed:s,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:f,mounted:h,beforeUpdate:p,updated:_,activated:x,deactivated:m,beforeDestroy:d,beforeUnmount:w,destroyed:T,unmounted:S,render:R,renderTracked:D,renderTriggered:P,errorCaptured:U,serverPrefetch:E,expose:b,inheritAttrs:C,components:O,directives:W,filters:K}=e;if(c&&Ym(c,i,null),o)for(const Q in o){const k=o[Q];Ve(k)&&(i[Q]=k.bind(t))}if(r){const Q=r.call(t,t);_t(Q)&&(n.data=Ko(Q))}if(_l=!0,s)for(const Q in s){const k=s[Q],he=Ve(k)?k.bind(t,t):Ve(k.get)?k.get.bind(t,t):Dn,xe=!Ve(k)&&Ve(k.set)?k.set.bind(t):Dn,Ce=bd({get:he,set:xe});Object.defineProperty(i,Q,{enumerable:!0,configurable:!0,get:()=>Ce.value,set:Ne=>Ce.value=Ne})}if(a)for(const Q in a)nd(a[Q],i,t,Q);if(l){const Q=Ve(l)?l.call(t):l;Reflect.ownKeys(Q).forEach(k=>{eg(k,Q[k])})}u&&Mu(u,n,"c");function Z(Q,k){Be(k)?k.forEach(he=>Q(he.bind(t))):k&&Q(k.bind(t))}if(Z(Fm,f),Z(Ci,h),Z(Om,p),Z(Bm,_),Z(Lm,x),Z(Um,m),Z(Vm,U),Z(Hm,D),Z(zm,P),Z(ea,w),Z(td,S),Z(km,E),Be(b))if(b.length){const Q=n.exposed||(n.exposed={});b.forEach(k=>{Object.defineProperty(Q,k,{get:()=>t[k],set:he=>t[k]=he,enumerable:!0})})}else n.exposed||(n.exposed={});R&&n.render===Dn&&(n.render=R),C!=null&&(n.inheritAttrs=C),O&&(n.components=O),W&&(n.directives=W),E&&Qh(n)}function Ym(n,e,t=Dn){Be(n)&&(n=vl(n));for(const i in n){const r=n[i];let s;_t(r)?"default"in r?s=ho(r.from||i,r.default,!0):s=ho(r.from||i):s=ho(r),Ft(s)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>s.value,set:o=>s.value=o}):e[i]=s}}function Mu(n,e,t){yn(Be(n)?n.map(i=>i.bind(e.proxy)):n.bind(e.proxy),e,t)}function nd(n,e,t,i){let r=i.includes(".")?gd(t,i):()=>t[i];if(Et(n)){const s=e[n];Ve(s)&&po(r,s)}else if(Ve(n))po(r,n.bind(t));else if(_t(n))if(Be(n))n.forEach(s=>nd(s,e,t,i));else{const s=Ve(n.handler)?n.handler.bind(t):e[n.handler];Ve(s)&&po(r,s,n)}}function id(n){const e=n.type,{mixins:t,extends:i}=e,{mixins:r,optionsCache:s,config:{optionMergeStrategies:o}}=n.appContext,a=s.get(e);let l;return a?l=a:!r.length&&!t&&!i?l=e:(l={},r.length&&r.forEach(c=>Do(l,c,o,!0)),Do(l,e,o)),_t(e)&&s.set(e,l),l}function Do(n,e,t,i=!1){const{mixins:r,extends:s}=e;s&&Do(n,s,t,!0),r&&r.forEach(o=>Do(n,o,t,!0));for(const o in e)if(!(i&&o==="expose")){const a=jm[o]||t&&t[o];n[o]=a?a(n[o],e[o]):e[o]}return n}const jm={data:Eu,props:bu,emits:bu,methods:ns,computed:ns,beforeCreate:kt,created:kt,beforeMount:kt,mounted:kt,beforeUpdate:kt,updated:kt,beforeDestroy:kt,beforeUnmount:kt,destroyed:kt,unmounted:kt,activated:kt,deactivated:kt,errorCaptured:kt,serverPrefetch:kt,components:ns,directives:ns,watch:Zm,provide:Eu,inject:Km};function Eu(n,e){return e?n?function(){return Rt(Ve(n)?n.call(this,this):n,Ve(e)?e.call(this,this):e)}:e:n}function Km(n,e){return ns(vl(n),vl(e))}function vl(n){if(Be(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function kt(n,e){return n?[...new Set([].concat(n,e))]:e}function ns(n,e){return n?Rt(Object.create(null),n,e):e}function bu(n,e){return n?Be(n)&&Be(e)?[...new Set([...n,...e])]:Rt(Object.create(null),yu(n),yu(e??{})):e}function Zm(n,e){if(!n)return e;if(!e)return n;const t=Rt(Object.create(null),n);for(const i in e)t[i]=kt(n[i],e[i]);return t}function rd(){return{app:null,config:{isNativeTag:Bp,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Jm=0;function Qm(n,e){return function(i,r=null){Ve(i)||(i=Rt({},i)),r!=null&&!_t(r)&&(r=null);const s=rd(),o=new WeakSet,a=[];let l=!1;const c=s.app={_uid:Jm++,_component:i,_props:r,_container:null,_context:s,_instance:null,version:Fg,get config(){return s.config},set config(u){},use(u,...f){return o.has(u)||(u&&Ve(u.install)?(o.add(u),u.install(c,...f)):Ve(u)&&(o.add(u),u(c,...f))),c},mixin(u){return s.mixins.includes(u)||s.mixins.push(u),c},component(u,f){return f?(s.components[u]=f,c):s.components[u]},directive(u,f){return f?(s.directives[u]=f,c):s.directives[u]},mount(u,f,h){if(!l){const p=c._ceVNode||gt(i,r);return p.appContext=s,h===!0?h="svg":h===!1&&(h=void 0),n(p,u,h),l=!0,c._container=u,u.__vue_app__=c,ia(p.component)}},onUnmount(u){a.push(u)},unmount(){l&&(yn(a,c._instance,16),n(null,c._container),delete c._container.__vue_app__)},provide(u,f){return s.provides[u]=f,c},runWithContext(u){const f=Pr;Pr=c;try{return u()}finally{Pr=f}}};return c}}let Pr=null;function eg(n,e){if(Nt){let t=Nt.provides;const i=Nt.parent&&Nt.parent.provides;i===t&&(t=Nt.provides=Object.create(i)),t[n]=e}}function ho(n,e,t=!1){const i=yd();if(i||Pr){let r=Pr?Pr._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(r&&n in r)return r[n];if(arguments.length>1)return t&&Ve(e)?e.call(i&&i.proxy):e}}const sd={},od=()=>Object.create(sd),ad=n=>Object.getPrototypeOf(n)===sd;function tg(n,e,t,i=!1){const r={},s=od();n.propsDefaults=Object.create(null),ld(n,e,r,s);for(const o in n.propsOptions[0])o in r||(r[o]=void 0);t?n.props=i?r:gm(r):n.type.props?n.props=r:n.props=s,n.attrs=s}function ng(n,e,t,i){const{props:r,attrs:s,vnode:{patchFlag:o}}=n,a=Ke(r),[l]=n.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=n.vnode.dynamicProps;for(let f=0;f<u.length;f++){let h=u[f];if(ta(n.emitsOptions,h))continue;const p=e[h];if(l)if(et(s,h))p!==s[h]&&(s[h]=p,c=!0);else{const _=dn(h);r[_]=xl(l,a,_,p,n,!1)}else p!==s[h]&&(s[h]=p,c=!0)}}}else{ld(n,e,r,s)&&(c=!0);let u;for(const f in a)(!e||!et(e,f)&&((u=sr(f))===f||!et(e,u)))&&(l?t&&(t[f]!==void 0||t[u]!==void 0)&&(r[f]=xl(l,a,f,void 0,n,!0)):delete r[f]);if(s!==a)for(const f in s)(!e||!et(e,f))&&(delete s[f],c=!0)}c&&$n(n.attrs,"set","")}function ld(n,e,t,i){const[r,s]=n.propsOptions;let o=!1,a;if(e)for(let l in e){if(rs(l))continue;const c=e[l];let u;r&&et(r,u=dn(l))?!s||!s.includes(u)?t[u]=c:(a||(a={}))[u]=c:ta(n.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,o=!0)}if(s){const l=Ke(t),c=a||ft;for(let u=0;u<s.length;u++){const f=s[u];t[f]=xl(r,l,f,c[f],n,!et(c,f))}}return o}function xl(n,e,t,i,r,s){const o=n[t];if(o!=null){const a=et(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&Ve(l)){const{propsDefaults:c}=r;if(t in c)i=c[t];else{const u=Rs(r);i=c[t]=l.call(null,e),u()}}else i=l;r.ce&&r.ce._setProp(t,i)}o[0]&&(s&&!a?i=!1:o[1]&&(i===""||i===sr(t))&&(i=!0))}return i}const ig=new WeakMap;function cd(n,e,t=!1){const i=t?ig:e.propsCache,r=i.get(n);if(r)return r;const s=n.props,o={},a=[];let l=!1;if(!Ve(n)){const u=f=>{l=!0;const[h,p]=cd(f,e,!0);Rt(o,h),p&&a.push(...p)};!t&&e.mixins.length&&e.mixins.forEach(u),n.extends&&u(n.extends),n.mixins&&n.mixins.forEach(u)}if(!s&&!l)return _t(n)&&i.set(n,Ar),Ar;if(Be(s))for(let u=0;u<s.length;u++){const f=dn(s[u]);Tu(f)&&(o[f]=ft)}else if(s)for(const u in s){const f=dn(u);if(Tu(f)){const h=s[u],p=o[f]=Be(h)||Ve(h)?{type:h}:Rt({},h),_=p.type;let x=!1,m=!0;if(Be(_))for(let d=0;d<_.length;++d){const w=_[d],T=Ve(w)&&w.name;if(T==="Boolean"){x=!0;break}else T==="String"&&(m=!1)}else x=Ve(_)&&_.name==="Boolean";p[0]=x,p[1]=m,(x||et(p,"default"))&&a.push(f)}}const c=[o,a];return _t(n)&&i.set(n,c),c}function Tu(n){return n[0]!=="$"&&!rs(n)}const Uc=n=>n==="_"||n==="__"||n==="_ctx"||n==="$stable",Nc=n=>Be(n)?n.map(An):[An(n)],rg=(n,e,t)=>{if(e._n)return e;const i=as((...r)=>Nc(e(...r)),t);return i._c=!1,i},ud=(n,e,t)=>{const i=n._ctx;for(const r in n){if(Uc(r))continue;const s=n[r];if(Ve(s))e[r]=rg(r,s,i);else if(s!=null){const o=Nc(s);e[r]=()=>o}}},fd=(n,e)=>{const t=Nc(e);n.slots.default=()=>t},hd=(n,e,t)=>{for(const i in e)(t||!Uc(i))&&(n[i]=e[i])},sg=(n,e,t)=>{const i=n.slots=od();if(n.vnode.shapeFlag&32){const r=e.__;r&&cl(i,"__",r,!0);const s=e._;s?(hd(i,e,t),t&&cl(i,"_",s,!0)):ud(e,i)}else e&&fd(n,e)},og=(n,e,t)=>{const{vnode:i,slots:r}=n;let s=!0,o=ft;if(i.shapeFlag&32){const a=e._;a?t&&a===1?s=!1:hd(r,e,t):(s=!e.$stable,ud(e,r)),o=e}else e&&(fd(n,e),o={default:1});if(s)for(const a in r)!Uc(a)&&o[a]==null&&delete r[a]},tn=Sg;function ag(n){return lg(n)}function lg(n,e){const t=Yo();t.__VUE__=!0;const{insert:i,remove:r,patchProp:s,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:f,nextSibling:h,setScopeId:p=Dn,insertStaticContent:_}=n,x=(A,v,H,X=null,j=null,G=null,se=void 0,q=null,ee=!!v.dynamicChildren)=>{if(A===v)return;A&&!Ki(A,v)&&(X=fe(A),Ne(A,j,G,!0),A=null),v.patchFlag===-2&&(ee=!1,v.dynamicChildren=null);const{type:ie,ref:ge,shapeFlag:y}=v;switch(ie){case na:m(A,v,H,X);break;case Gt:d(A,v,H,X);break;case Sa:A==null&&w(v,H,X,se);break;case Ut:O(A,v,H,X,j,G,se,q,ee);break;default:y&1?R(A,v,H,X,j,G,se,q,ee):y&6?W(A,v,H,X,j,G,se,q,ee):(y&64||y&128)&&ie.process(A,v,H,X,j,G,se,q,ee,Fe)}ge!=null&&j?ls(ge,A&&A.ref,G,v||A,!v):ge==null&&A&&A.ref!=null&&ls(A.ref,null,G,A,!0)},m=(A,v,H,X)=>{if(A==null)i(v.el=a(v.children),H,X);else{const j=v.el=A.el;v.children!==A.children&&c(j,v.children)}},d=(A,v,H,X)=>{A==null?i(v.el=l(v.children||""),H,X):v.el=A.el},w=(A,v,H,X)=>{[A.el,A.anchor]=_(A.children,v,H,X,A.el,A.anchor)},T=({el:A,anchor:v},H,X)=>{let j;for(;A&&A!==v;)j=h(A),i(A,H,X),A=j;i(v,H,X)},S=({el:A,anchor:v})=>{let H;for(;A&&A!==v;)H=h(A),r(A),A=H;r(v)},R=(A,v,H,X,j,G,se,q,ee)=>{v.type==="svg"?se="svg":v.type==="math"&&(se="mathml"),A==null?D(v,H,X,j,G,se,q,ee):E(A,v,j,G,se,q,ee)},D=(A,v,H,X,j,G,se,q)=>{let ee,ie;const{props:ge,shapeFlag:y,transition:g,dirs:I}=A;if(ee=A.el=o(A.type,G,ge&&ge.is,ge),y&8?u(ee,A.children):y&16&&U(A.children,ee,null,X,j,xa(A,G),se,q),I&&Ii(A,null,X,"created"),P(ee,A,A.scopeId,se,X),ge){for(const J in ge)J!=="value"&&!rs(J)&&s(ee,J,null,ge[J],G,X);"value"in ge&&s(ee,"value",null,ge.value,G),(ie=ge.onVnodeBeforeMount)&&En(ie,X,A)}I&&Ii(A,null,X,"beforeMount");const z=cg(j,g);z&&g.beforeEnter(ee),i(ee,v,H),((ie=ge&&ge.onVnodeMounted)||z||I)&&tn(()=>{ie&&En(ie,X,A),z&&g.enter(ee),I&&Ii(A,null,X,"mounted")},j)},P=(A,v,H,X,j)=>{if(H&&p(A,H),X)for(let G=0;G<X.length;G++)p(A,X[G]);if(j){let G=j.subTree;if(v===G||vd(G.type)&&(G.ssContent===v||G.ssFallback===v)){const se=j.vnode;P(A,se,se.scopeId,se.slotScopeIds,j.parent)}}},U=(A,v,H,X,j,G,se,q,ee=0)=>{for(let ie=ee;ie<A.length;ie++){const ge=A[ie]=q?_i(A[ie]):An(A[ie]);x(null,ge,v,H,X,j,G,se,q)}},E=(A,v,H,X,j,G,se)=>{const q=v.el=A.el;let{patchFlag:ee,dynamicChildren:ie,dirs:ge}=v;ee|=A.patchFlag&16;const y=A.props||ft,g=v.props||ft;let I;if(H&&Li(H,!1),(I=g.onVnodeBeforeUpdate)&&En(I,H,v,A),ge&&Ii(v,A,H,"beforeUpdate"),H&&Li(H,!0),(y.innerHTML&&g.innerHTML==null||y.textContent&&g.textContent==null)&&u(q,""),ie?b(A.dynamicChildren,ie,q,H,X,xa(v,j),G):se||k(A,v,q,null,H,X,xa(v,j),G,!1),ee>0){if(ee&16)C(q,y,g,H,j);else if(ee&2&&y.class!==g.class&&s(q,"class",null,g.class,j),ee&4&&s(q,"style",y.style,g.style,j),ee&8){const z=v.dynamicProps;for(let J=0;J<z.length;J++){const V=z[J],ye=y[V],oe=g[V];(oe!==ye||V==="value")&&s(q,V,ye,oe,j,H)}}ee&1&&A.children!==v.children&&u(q,v.children)}else!se&&ie==null&&C(q,y,g,H,j);((I=g.onVnodeUpdated)||ge)&&tn(()=>{I&&En(I,H,v,A),ge&&Ii(v,A,H,"updated")},X)},b=(A,v,H,X,j,G,se)=>{for(let q=0;q<v.length;q++){const ee=A[q],ie=v[q],ge=ee.el&&(ee.type===Ut||!Ki(ee,ie)||ee.shapeFlag&198)?f(ee.el):H;x(ee,ie,ge,null,X,j,G,se,!0)}},C=(A,v,H,X,j)=>{if(v!==H){if(v!==ft)for(const G in v)!rs(G)&&!(G in H)&&s(A,G,v[G],null,j,X);for(const G in H){if(rs(G))continue;const se=H[G],q=v[G];se!==q&&G!=="value"&&s(A,G,q,se,j,X)}"value"in H&&s(A,"value",v.value,H.value,j)}},O=(A,v,H,X,j,G,se,q,ee)=>{const ie=v.el=A?A.el:a(""),ge=v.anchor=A?A.anchor:a("");let{patchFlag:y,dynamicChildren:g,slotScopeIds:I}=v;I&&(q=q?q.concat(I):I),A==null?(i(ie,H,X),i(ge,H,X),U(v.children||[],H,ge,j,G,se,q,ee)):y>0&&y&64&&g&&A.dynamicChildren?(b(A.dynamicChildren,g,H,j,G,se,q),(v.key!=null||j&&v===j.subTree)&&dd(A,v,!0)):k(A,v,H,ge,j,G,se,q,ee)},W=(A,v,H,X,j,G,se,q,ee)=>{v.slotScopeIds=q,A==null?v.shapeFlag&512?j.ctx.activate(v,H,X,se,ee):K(v,H,X,j,G,se,ee):ne(A,v,ee)},K=(A,v,H,X,j,G,se)=>{const q=A.component=Cg(A,X,j);if(Jo(A)&&(q.ctx.renderer=Fe),Rg(q,!1,se),q.asyncDep){if(j&&j.registerDep(q,Z,se),!A.el){const ee=q.subTree=gt(Gt);d(null,ee,v,H),A.placeholder=ee.el}}else Z(q,A,v,H,j,G,se)},ne=(A,v,H)=>{const X=v.component=A.component;if(vg(A,v,H))if(X.asyncDep&&!X.asyncResolved){Q(X,v,H);return}else X.next=v,X.update();else v.el=A.el,X.vnode=v},Z=(A,v,H,X,j,G,se)=>{const q=()=>{if(A.isMounted){let{next:y,bu:g,u:I,parent:z,vnode:J}=A;{const Ee=pd(A);if(Ee){y&&(y.el=J.el,Q(A,y,se)),Ee.asyncDep.then(()=>{A.isUnmounted||q()});return}}let V=y,ye;Li(A,!1),y?(y.el=J.el,Q(A,y,se)):y=J,g&&fo(g),(ye=y.props&&y.props.onVnodeBeforeUpdate)&&En(ye,z,y,J),Li(A,!0);const oe=wu(A),Me=A.subTree;A.subTree=oe,x(Me,oe,f(Me.el),fe(Me),A,j,G),y.el=oe.el,V===null&&xg(A,oe.el),I&&tn(I,j),(ye=y.props&&y.props.onVnodeUpdated)&&tn(()=>En(ye,z,y,J),j)}else{let y;const{el:g,props:I}=v,{bm:z,m:J,parent:V,root:ye,type:oe}=A,Me=cs(v);Li(A,!1),z&&fo(z),!Me&&(y=I&&I.onVnodeBeforeMount)&&En(y,V,v),Li(A,!0);{ye.ce&&ye.ce._def.shadowRoot!==!1&&ye.ce._injectChildStyle(oe);const Ee=A.subTree=wu(A);x(null,Ee,H,X,A,j,G),v.el=Ee.el}if(J&&tn(J,j),!Me&&(y=I&&I.onVnodeMounted)){const Ee=v;tn(()=>En(y,V,Ee),j)}(v.shapeFlag&256||V&&cs(V.vnode)&&V.vnode.shapeFlag&256)&&A.a&&tn(A.a,j),A.isMounted=!0,v=H=X=null}};A.scope.on();const ee=A.effect=new bh(q);A.scope.off();const ie=A.update=ee.run.bind(ee),ge=A.job=ee.runIfDirty.bind(ee);ge.i=A,ge.id=A.uid,ee.scheduler=()=>Lc(ge),Li(A,!0),ie()},Q=(A,v,H)=>{v.component=A;const X=A.vnode.props;A.vnode=v,A.next=null,ng(A,v.props,X,H),og(A,v.children,H),ei(),_u(A),ti()},k=(A,v,H,X,j,G,se,q,ee=!1)=>{const ie=A&&A.children,ge=A?A.shapeFlag:0,y=v.children,{patchFlag:g,shapeFlag:I}=v;if(g>0){if(g&128){xe(ie,y,H,X,j,G,se,q,ee);return}else if(g&256){he(ie,y,H,X,j,G,se,q,ee);return}}I&8?(ge&16&&de(ie,j,G),y!==ie&&u(H,y)):ge&16?I&16?xe(ie,y,H,X,j,G,se,q,ee):de(ie,j,G,!0):(ge&8&&u(H,""),I&16&&U(y,H,X,j,G,se,q,ee))},he=(A,v,H,X,j,G,se,q,ee)=>{A=A||Ar,v=v||Ar;const ie=A.length,ge=v.length,y=Math.min(ie,ge);let g;for(g=0;g<y;g++){const I=v[g]=ee?_i(v[g]):An(v[g]);x(A[g],I,H,null,j,G,se,q,ee)}ie>ge?de(A,j,G,!0,!1,y):U(v,H,X,j,G,se,q,ee,y)},xe=(A,v,H,X,j,G,se,q,ee)=>{let ie=0;const ge=v.length;let y=A.length-1,g=ge-1;for(;ie<=y&&ie<=g;){const I=A[ie],z=v[ie]=ee?_i(v[ie]):An(v[ie]);if(Ki(I,z))x(I,z,H,null,j,G,se,q,ee);else break;ie++}for(;ie<=y&&ie<=g;){const I=A[y],z=v[g]=ee?_i(v[g]):An(v[g]);if(Ki(I,z))x(I,z,H,null,j,G,se,q,ee);else break;y--,g--}if(ie>y){if(ie<=g){const I=g+1,z=I<ge?v[I].el:X;for(;ie<=g;)x(null,v[ie]=ee?_i(v[ie]):An(v[ie]),H,z,j,G,se,q,ee),ie++}}else if(ie>g)for(;ie<=y;)Ne(A[ie],j,G,!0),ie++;else{const I=ie,z=ie,J=new Map;for(ie=z;ie<=g;ie++){const we=v[ie]=ee?_i(v[ie]):An(v[ie]);we.key!=null&&J.set(we.key,ie)}let V,ye=0;const oe=g-z+1;let Me=!1,Ee=0;const ae=new Array(oe);for(ie=0;ie<oe;ie++)ae[ie]=0;for(ie=I;ie<=y;ie++){const we=A[ie];if(ye>=oe){Ne(we,j,G,!0);continue}let be;if(we.key!=null)be=J.get(we.key);else for(V=z;V<=g;V++)if(ae[V-z]===0&&Ki(we,v[V])){be=V;break}be===void 0?Ne(we,j,G,!0):(ae[be-z]=ie+1,be>=Ee?Ee=be:Me=!0,x(we,v[be],H,null,j,G,se,q,ee),ye++)}const ve=Me?ug(ae):Ar;for(V=ve.length-1,ie=oe-1;ie>=0;ie--){const we=z+ie,be=v[we],me=v[we+1],ze=we+1<ge?me.el||me.placeholder:X;ae[ie]===0?x(null,be,H,ze,j,G,se,q,ee):Me&&(V<0||ie!==ve[V]?Ce(be,H,ze,2):V--)}}},Ce=(A,v,H,X,j=null)=>{const{el:G,type:se,transition:q,children:ee,shapeFlag:ie}=A;if(ie&6){Ce(A.component.subTree,v,H,X);return}if(ie&128){A.suspense.move(v,H,X);return}if(ie&64){se.move(A,v,H,Fe);return}if(se===Ut){i(G,v,H);for(let y=0;y<ee.length;y++)Ce(ee[y],v,H,X);i(A.anchor,v,H);return}if(se===Sa){T(A,v,H);return}if(X!==2&&ie&1&&q)if(X===0)q.beforeEnter(G),i(G,v,H),tn(()=>q.enter(G),j);else{const{leave:y,delayLeave:g,afterLeave:I}=q,z=()=>{A.ctx.isUnmounted?r(G):i(G,v,H)},J=()=>{y(G,()=>{z(),I&&I()})};g?g(G,z,J):J()}else i(G,v,H)},Ne=(A,v,H,X=!1,j=!1)=>{const{type:G,props:se,ref:q,children:ee,dynamicChildren:ie,shapeFlag:ge,patchFlag:y,dirs:g,cacheIndex:I}=A;if(y===-2&&(j=!1),q!=null&&(ei(),ls(q,null,H,A,!0),ti()),I!=null&&(v.renderCache[I]=void 0),ge&256){v.ctx.deactivate(A);return}const z=ge&1&&g,J=!cs(A);let V;if(J&&(V=se&&se.onVnodeBeforeUnmount)&&En(V,v,A),ge&6)te(A.component,H,X);else{if(ge&128){A.suspense.unmount(H,X);return}z&&Ii(A,null,v,"beforeUnmount"),ge&64?A.type.remove(A,v,H,Fe,X):ie&&!ie.hasOnce&&(G!==Ut||y>0&&y&64)?de(ie,v,H,!1,!0):(G===Ut&&y&384||!j&&ge&16)&&de(ee,v,H),X&&ct(A)}(J&&(V=se&&se.onVnodeUnmounted)||z)&&tn(()=>{V&&En(V,v,A),z&&Ii(A,null,v,"unmounted")},H)},ct=A=>{const{type:v,el:H,anchor:X,transition:j}=A;if(v===Ut){rt(H,X);return}if(v===Sa){S(A);return}const G=()=>{r(H),j&&!j.persisted&&j.afterLeave&&j.afterLeave()};if(A.shapeFlag&1&&j&&!j.persisted){const{leave:se,delayLeave:q}=j,ee=()=>se(H,G);q?q(A.el,G,ee):ee()}else G()},rt=(A,v)=>{let H;for(;A!==v;)H=h(A),r(A),A=H;r(v)},te=(A,v,H)=>{const{bum:X,scope:j,job:G,subTree:se,um:q,m:ee,a:ie,parent:ge,slots:{__:y}}=A;Au(ee),Au(ie),X&&fo(X),ge&&Be(y)&&y.forEach(g=>{ge.renderCache[g]=void 0}),j.stop(),G&&(G.flags|=8,Ne(se,A,v,H)),q&&tn(q,v),tn(()=>{A.isUnmounted=!0},v),v&&v.pendingBranch&&!v.isUnmounted&&A.asyncDep&&!A.asyncResolved&&A.suspenseId===v.pendingId&&(v.deps--,v.deps===0&&v.resolve())},de=(A,v,H,X=!1,j=!1,G=0)=>{for(let se=G;se<A.length;se++)Ne(A[se],v,H,X,j)},fe=A=>{if(A.shapeFlag&6)return fe(A.component.subTree);if(A.shapeFlag&128)return A.suspense.next();const v=h(A.anchor||A.el),H=v&&v[Rm];return H?h(H):v};let De=!1;const Le=(A,v,H)=>{A==null?v._vnode&&Ne(v._vnode,null,null,!0):x(v._vnode||null,A,v,null,null,null,H),v._vnode=A,De||(De=!0,_u(),Wh(),De=!1)},Fe={p:x,um:Ne,m:Ce,r:ct,mt:K,mc:U,pc:k,pbc:b,n:fe,o:n};return{render:Le,hydrate:void 0,createApp:Qm(Le)}}function xa({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function Li({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function cg(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function dd(n,e,t=!1){const i=n.children,r=e.children;if(Be(i)&&Be(r))for(let s=0;s<i.length;s++){const o=i[s];let a=r[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[s]=_i(r[s]),a.el=o.el),!t&&a.patchFlag!==-2&&dd(o,a)),a.type===na&&(a.el=o.el),a.type===Gt&&!a.el&&(a.el=o.el)}}function ug(n){const e=n.slice(),t=[0];let i,r,s,o,a;const l=n.length;for(i=0;i<l;i++){const c=n[i];if(c!==0){if(r=t[t.length-1],n[r]<c){e[i]=r,t.push(i);continue}for(s=0,o=t.length-1;s<o;)a=s+o>>1,n[t[a]]<c?s=a+1:o=a;c<n[t[s]]&&(s>0&&(e[i]=t[s-1]),t[s]=i)}}for(s=t.length,o=t[s-1];s-- >0;)t[s]=o,o=e[o];return t}function pd(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:pd(e)}function Au(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}const fg=Symbol.for("v-scx"),hg=()=>ho(fg);function po(n,e,t){return md(n,e,t)}function md(n,e,t=ft){const{immediate:i,deep:r,flush:s,once:o}=t,a=Rt({},t),l=e&&i||!e&&s!=="post";let c;if(Ss){if(s==="sync"){const p=hg();c=p.__watcherHandles||(p.__watcherHandles=[])}else if(!l){const p=()=>{};return p.stop=Dn,p.resume=Dn,p.pause=Dn,p}}const u=Nt;a.call=(p,_,x)=>yn(p,u,_,x);let f=!1;s==="post"?a.scheduler=p=>{tn(p,u&&u.suspense)}:s!=="sync"&&(f=!0,a.scheduler=(p,_)=>{_?p():Lc(p)}),a.augmentJob=p=>{e&&(p.flags|=4),f&&(p.flags|=2,u&&(p.id=u.uid,p.i=u))};const h=bm(n,e,a);return Ss&&(c?c.push(h):l&&h()),h}function dg(n,e,t){const i=this.proxy,r=Et(n)?n.includes(".")?gd(i,n):()=>i[n]:n.bind(i,i);let s;Ve(e)?s=e:(s=e.handler,t=e);const o=Rs(this),a=md(r,s.bind(i),t);return o(),a}function gd(n,e){const t=e.split(".");return()=>{let i=n;for(let r=0;r<t.length&&i;r++)i=i[t[r]];return i}}const pg=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${dn(e)}Modifiers`]||n[`${sr(e)}Modifiers`];function mg(n,e,...t){if(n.isUnmounted)return;const i=n.vnode.props||ft;let r=t;const s=e.startsWith("update:"),o=s&&pg(i,e.slice(7));o&&(o.trim&&(r=t.map(u=>Et(u)?u.trim():u)),o.number&&(r=t.map(ul)));let a,l=i[a=ha(e)]||i[a=ha(dn(e))];!l&&s&&(l=i[a=ha(sr(e))]),l&&yn(l,n,6,r);const c=i[a+"Once"];if(c){if(!n.emitted)n.emitted={};else if(n.emitted[a])return;n.emitted[a]=!0,yn(c,n,6,r)}}function _d(n,e,t=!1){const i=e.emitsCache,r=i.get(n);if(r!==void 0)return r;const s=n.emits;let o={},a=!1;if(!Ve(n)){const l=c=>{const u=_d(c,e,!0);u&&(a=!0,Rt(o,u))};!t&&e.mixins.length&&e.mixins.forEach(l),n.extends&&l(n.extends),n.mixins&&n.mixins.forEach(l)}return!s&&!a?(_t(n)&&i.set(n,null),null):(Be(s)?s.forEach(l=>o[l]=null):Rt(o,s),_t(n)&&i.set(n,o),o)}function ta(n,e){return!n||!Wo(e)?!1:(e=e.slice(2).replace(/Once$/,""),et(n,e[0].toLowerCase()+e.slice(1))||et(n,sr(e))||et(n,e))}function wu(n){const{type:e,vnode:t,proxy:i,withProxy:r,propsOptions:[s],slots:o,attrs:a,emit:l,render:c,renderCache:u,props:f,data:h,setupState:p,ctx:_,inheritAttrs:x}=n,m=Ro(n);let d,w;try{if(t.shapeFlag&4){const S=r||i,R=S;d=An(c.call(R,S,u,f,p,h,_)),w=a}else{const S=e;d=An(S.length>1?S(f,{attrs:a,slots:o,emit:l}):S(f,null)),w=e.props?a:gg(a)}}catch(S){fs.length=0,Zo(S,n,1),d=gt(Gt)}let T=d;if(w&&x!==!1){const S=Object.keys(w),{shapeFlag:R}=T;S.length&&R&7&&(s&&S.some(yc)&&(w=_g(w,s)),T=Ti(T,w,!1,!0))}return t.dirs&&(T=Ti(T,null,!1,!0),T.dirs=T.dirs?T.dirs.concat(t.dirs):t.dirs),t.transition&&_s(T,t.transition),d=T,Ro(m),d}const gg=n=>{let e;for(const t in n)(t==="class"||t==="style"||Wo(t))&&((e||(e={}))[t]=n[t]);return e},_g=(n,e)=>{const t={};for(const i in n)(!yc(i)||!(i.slice(9)in e))&&(t[i]=n[i]);return t};function vg(n,e,t){const{props:i,children:r,component:s}=n,{props:o,children:a,patchFlag:l}=e,c=s.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&l>=0){if(l&1024)return!0;if(l&16)return i?Cu(i,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let f=0;f<u.length;f++){const h=u[f];if(o[h]!==i[h]&&!ta(c,h))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?Cu(i,o,c):!0:!!o;return!1}function Cu(n,e,t){const i=Object.keys(e);if(i.length!==Object.keys(n).length)return!0;for(let r=0;r<i.length;r++){const s=i[r];if(e[s]!==n[s]&&!ta(t,s))return!0}return!1}function xg({vnode:n,parent:e},t){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===n&&(i.el=n.el),i===n)(n=e.vnode).el=t,e=e.parent;else break}}const vd=n=>n.__isSuspense;function Sg(n,e){e&&e.pendingBranch?Be(n)?e.effects.push(...n):e.effects.push(n):wm(n)}const Ut=Symbol.for("v-fgt"),na=Symbol.for("v-txt"),Gt=Symbol.for("v-cmt"),Sa=Symbol.for("v-stc"),fs=[];let on=null;function Ze(n=!1){fs.push(on=n?null:[])}function yg(){fs.pop(),on=fs[fs.length-1]||null}let vs=1;function Ru(n,e=!1){vs+=n,n<0&&on&&e&&(on.hasOnce=!0)}function xd(n){return n.dynamicChildren=vs>0?on||Ar:null,yg(),vs>0&&on&&on.push(n),n}function tt(n,e,t,i,r,s){return xd(Xe(n,e,t,i,r,s,!0))}function Mg(n,e,t,i,r){return xd(gt(n,e,t,i,r,!0))}function Io(n){return n?n.__v_isVNode===!0:!1}function Ki(n,e){return n.type===e.type&&n.key===e.key}const Sd=({key:n})=>n??null,mo=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?Et(n)||Ft(n)||Ve(n)?{i:sn,r:n,k:e,f:!!t}:n:null);function Xe(n,e=null,t=null,i=0,r=null,s=n===Ut?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&Sd(e),ref:e&&mo(e),scopeId:$h,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:i,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:sn};return a?(Fc(l,t),s&128&&n.normalize(l)):t&&(l.shapeFlag|=Et(t)?8:16),vs>0&&!o&&on&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&on.push(l),l}const gt=Eg;function Eg(n,e=null,t=null,i=0,r=null,s=!1){if((!n||n===Wm)&&(n=Gt),Io(n)){const a=Ti(n,e,!0);return t&&Fc(a,t),vs>0&&!s&&on&&(a.shapeFlag&6?on[on.indexOf(n)]=a:on.push(a)),a.patchFlag=-2,a}if(Ug(n)&&(n=n.__vccOpts),e){e=bg(e);let{class:a,style:l}=e;a&&!Et(a)&&(e.class=Tc(a)),_t(l)&&(Ic(l)&&!Be(l)&&(l=Rt({},l)),e.style=bc(l))}const o=Et(n)?1:vd(n)?128:qh(n)?64:_t(n)?4:Ve(n)?2:0;return Xe(n,e,t,i,r,o,s,!0)}function bg(n){return n?Ic(n)||ad(n)?Rt({},n):n:null}function Ti(n,e,t=!1,i=!1){const{props:r,ref:s,patchFlag:o,children:a,transition:l}=n,c=e?Tg(r||{},e):r,u={__v_isVNode:!0,__v_skip:!0,type:n.type,props:c,key:c&&Sd(c),ref:e&&e.ref?t&&s?Be(s)?s.concat(mo(e)):[s,mo(e)]:mo(e):s,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:a,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==Ut?o===-1?16:o|16:o,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:l,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Ti(n.ssContent),ssFallback:n.ssFallback&&Ti(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return l&&i&&_s(u,l.clone(u)),u}function xs(n=" ",e=0){return gt(na,null,n,e)}function jn(n="",e=!1){return e?(Ze(),Mg(Gt,null,n)):gt(Gt,null,n)}function An(n){return n==null||typeof n=="boolean"?gt(Gt):Be(n)?gt(Ut,null,n.slice()):Io(n)?_i(n):gt(na,null,String(n))}function _i(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Ti(n)}function Fc(n,e){let t=0;const{shapeFlag:i}=n;if(e==null)e=null;else if(Be(e))t=16;else if(typeof e=="object")if(i&65){const r=e.default;r&&(r._c&&(r._d=!1),Fc(n,r()),r._c&&(r._d=!0));return}else{t=32;const r=e._;!r&&!ad(e)?e._ctx=sn:r===3&&sn&&(sn.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else Ve(e)?(e={default:e,_ctx:sn},t=32):(e=String(e),i&64?(t=16,e=[xs(e)]):t=8);n.children=e,n.shapeFlag|=t}function Tg(...n){const e={};for(let t=0;t<n.length;t++){const i=n[t];for(const r in i)if(r==="class")e.class!==i.class&&(e.class=Tc([e.class,i.class]));else if(r==="style")e.style=bc([e.style,i.style]);else if(Wo(r)){const s=e[r],o=i[r];o&&s!==o&&!(Be(s)&&s.includes(o))&&(e[r]=s?[].concat(s,o):o)}else r!==""&&(e[r]=i[r])}return e}function En(n,e,t,i=null){yn(n,e,7,[t,i])}const Ag=rd();let wg=0;function Cg(n,e,t){const i=n.type,r=(e?e.appContext:n.appContext)||Ag,s={uid:wg++,vnode:n,type:i,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Kp(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:cd(i,r),emitsOptions:_d(i,r),emit:null,emitted:null,propsDefaults:ft,inheritAttrs:i.inheritAttrs,ctx:ft,data:ft,props:ft,attrs:ft,slots:ft,refs:ft,setupState:ft,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=mg.bind(null,s),n.ce&&n.ce(s),s}let Nt=null;const yd=()=>Nt||sn;let Lo,Sl;{const n=Yo(),e=(t,i)=>{let r;return(r=n[t])||(r=n[t]=[]),r.push(i),s=>{r.length>1?r.forEach(o=>o(s)):r[0](s)}};Lo=e("__VUE_INSTANCE_SETTERS__",t=>Nt=t),Sl=e("__VUE_SSR_SETTERS__",t=>Ss=t)}const Rs=n=>{const e=Nt;return Lo(n),n.scope.on(),()=>{n.scope.off(),Lo(e)}},Pu=()=>{Nt&&Nt.scope.off(),Lo(null)};function Md(n){return n.vnode.shapeFlag&4}let Ss=!1;function Rg(n,e=!1,t=!1){e&&Sl(e);const{props:i,children:r}=n.vnode,s=Md(n);tg(n,i,s,e),sg(n,r,t||e);const o=s?Pg(n,e):void 0;return e&&Sl(!1),o}function Pg(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,$m);const{setup:i}=t;if(i){ei();const r=n.setupContext=i.length>1?Ig(n):null,s=Rs(n),o=Cs(i,n,0,[n.props,r]),a=vh(o);if(ti(),s(),(a||n.sp)&&!cs(n)&&Qh(n),a){if(o.then(Pu,Pu),e)return o.then(l=>{Du(n,l)}).catch(l=>{Zo(l,n,0)});n.asyncDep=o}else Du(n,o)}else Ed(n)}function Du(n,e,t){Ve(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:_t(e)&&(n.setupState=zh(e)),Ed(n)}function Ed(n,e,t){const i=n.type;n.render||(n.render=i.render||Dn);{const r=Rs(n);ei();try{qm(n)}finally{ti(),r()}}}const Dg={get(n,e){return Lt(n,"get",""),n[e]}};function Ig(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,Dg),slots:n.slots,emit:n.emit,expose:e}}function ia(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(zh(_m(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in us)return us[t](n)},has(e,t){return t in e||t in us}})):n.proxy}function Lg(n,e=!0){return Ve(n)?n.displayName||n.name:n.name||e&&n.__name}function Ug(n){return Ve(n)&&"__vccOpts"in n}const bd=(n,e)=>Mm(n,e,Ss);function Ng(n,e,t){const i=arguments.length;return i===2?_t(e)&&!Be(e)?Io(e)?gt(n,null,[e]):gt(n,e):gt(n,null,e):(i>3?t=Array.prototype.slice.call(arguments,2):i===3&&Io(t)&&(t=[t]),gt(n,e,t))}const Fg="3.5.18";/**
* @vue/runtime-dom v3.5.18
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let yl;const Iu=typeof window<"u"&&window.trustedTypes;if(Iu)try{yl=Iu.createPolicy("vue",{createHTML:n=>n})}catch{}const Td=yl?n=>yl.createHTML(n):n=>n,Og="http://www.w3.org/2000/svg",Bg="http://www.w3.org/1998/Math/MathML",Xn=typeof document<"u"?document:null,Lu=Xn&&Xn.createElement("template"),kg={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,i)=>{const r=e==="svg"?Xn.createElementNS(Og,n):e==="mathml"?Xn.createElementNS(Bg,n):t?Xn.createElement(n,{is:t}):Xn.createElement(n);return n==="select"&&i&&i.multiple!=null&&r.setAttribute("multiple",i.multiple),r},createText:n=>Xn.createTextNode(n),createComment:n=>Xn.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>Xn.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,i,r,s){const o=t?t.previousSibling:e.lastChild;if(r&&(r===s||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),t),!(r===s||!(r=r.nextSibling)););else{Lu.innerHTML=Td(i==="svg"?`<svg>${n}</svg>`:i==="mathml"?`<math>${n}</math>`:n);const a=Lu.content;if(i==="svg"||i==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,t)}return[o?o.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},ai="transition",qr="animation",ys=Symbol("_vtc"),Ad={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},zg=Rt({},Yh,Ad),Hg=n=>(n.displayName="Transition",n.props=zg,n),go=Hg((n,{slots:e})=>Ng(Im,Vg(n),e)),Ui=(n,e=[])=>{Be(n)?n.forEach(t=>t(...e)):n&&n(...e)},Uu=n=>n?Be(n)?n.some(e=>e.length>1):n.length>1:!1;function Vg(n){const e={};for(const O in n)O in Ad||(e[O]=n[O]);if(n.css===!1)return e;const{name:t="v",type:i,duration:r,enterFromClass:s=`${t}-enter-from`,enterActiveClass:o=`${t}-enter-active`,enterToClass:a=`${t}-enter-to`,appearFromClass:l=s,appearActiveClass:c=o,appearToClass:u=a,leaveFromClass:f=`${t}-leave-from`,leaveActiveClass:h=`${t}-leave-active`,leaveToClass:p=`${t}-leave-to`}=n,_=Gg(r),x=_&&_[0],m=_&&_[1],{onBeforeEnter:d,onEnter:w,onEnterCancelled:T,onLeave:S,onLeaveCancelled:R,onBeforeAppear:D=d,onAppear:P=w,onAppearCancelled:U=T}=e,E=(O,W,K,ne)=>{O._enterCancelled=ne,Ni(O,W?u:a),Ni(O,W?c:o),K&&K()},b=(O,W)=>{O._isLeaving=!1,Ni(O,f),Ni(O,p),Ni(O,h),W&&W()},C=O=>(W,K)=>{const ne=O?P:w,Z=()=>E(W,O,K);Ui(ne,[W,Z]),Nu(()=>{Ni(W,O?l:s),On(W,O?u:a),Uu(ne)||Fu(W,i,x,Z)})};return Rt(e,{onBeforeEnter(O){Ui(d,[O]),On(O,s),On(O,o)},onBeforeAppear(O){Ui(D,[O]),On(O,l),On(O,c)},onEnter:C(!1),onAppear:C(!0),onLeave(O,W){O._isLeaving=!0;const K=()=>b(O,W);On(O,f),O._enterCancelled?(On(O,h),ku()):(ku(),On(O,h)),Nu(()=>{O._isLeaving&&(Ni(O,f),On(O,p),Uu(S)||Fu(O,i,m,K))}),Ui(S,[O,K])},onEnterCancelled(O){E(O,!1,void 0,!0),Ui(T,[O])},onAppearCancelled(O){E(O,!0,void 0,!0),Ui(U,[O])},onLeaveCancelled(O){b(O),Ui(R,[O])}})}function Gg(n){if(n==null)return null;if(_t(n))return[ya(n.enter),ya(n.leave)];{const e=ya(n);return[e,e]}}function ya(n){return Gp(n)}function On(n,e){e.split(/\s+/).forEach(t=>t&&n.classList.add(t)),(n[ys]||(n[ys]=new Set)).add(e)}function Ni(n,e){e.split(/\s+/).forEach(i=>i&&n.classList.remove(i));const t=n[ys];t&&(t.delete(e),t.size||(n[ys]=void 0))}function Nu(n){requestAnimationFrame(()=>{requestAnimationFrame(n)})}let Wg=0;function Fu(n,e,t,i){const r=n._endId=++Wg,s=()=>{r===n._endId&&i()};if(t!=null)return setTimeout(s,t);const{type:o,timeout:a,propCount:l}=Xg(n,e);if(!o)return i();const c=o+"end";let u=0;const f=()=>{n.removeEventListener(c,h),s()},h=p=>{p.target===n&&++u>=l&&f()};setTimeout(()=>{u<l&&f()},a+1),n.addEventListener(c,h)}function Xg(n,e){const t=window.getComputedStyle(n),i=_=>(t[_]||"").split(", "),r=i(`${ai}Delay`),s=i(`${ai}Duration`),o=Ou(r,s),a=i(`${qr}Delay`),l=i(`${qr}Duration`),c=Ou(a,l);let u=null,f=0,h=0;e===ai?o>0&&(u=ai,f=o,h=s.length):e===qr?c>0&&(u=qr,f=c,h=l.length):(f=Math.max(o,c),u=f>0?o>c?ai:qr:null,h=u?u===ai?s.length:l.length:0);const p=u===ai&&/\b(transform|all)(,|$)/.test(i(`${ai}Property`).toString());return{type:u,timeout:f,propCount:h,hasTransform:p}}function Ou(n,e){for(;n.length<e.length;)n=n.concat(n);return Math.max(...e.map((t,i)=>Bu(t)+Bu(n[i])))}function Bu(n){return n==="auto"?0:Number(n.slice(0,-1).replace(",","."))*1e3}function ku(){return document.body.offsetHeight}function $g(n,e,t){const i=n[ys];i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const zu=Symbol("_vod"),qg=Symbol("_vsh"),Yg=Symbol(""),jg=/(^|;)\s*display\s*:/;function Kg(n,e,t){const i=n.style,r=Et(t);let s=!1;if(t&&!r){if(e)if(Et(e))for(const o of e.split(";")){const a=o.slice(0,o.indexOf(":")).trim();t[a]==null&&_o(i,a,"")}else for(const o in e)t[o]==null&&_o(i,o,"");for(const o in t)o==="display"&&(s=!0),_o(i,o,t[o])}else if(r){if(e!==t){const o=i[Yg];o&&(t+=";"+o),i.cssText=t,s=jg.test(t)}}else e&&n.removeAttribute("style");zu in n&&(n[zu]=s?i.display:"",n[qg]&&(i.display="none"))}const Hu=/\s*!important$/;function _o(n,e,t){if(Be(t))t.forEach(i=>_o(n,e,i));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const i=Zg(n,e);Hu.test(t)?n.setProperty(sr(i),t.replace(Hu,""),"important"):n[i]=t}}const Vu=["Webkit","Moz","ms"],Ma={};function Zg(n,e){const t=Ma[e];if(t)return t;let i=dn(e);if(i!=="filter"&&i in n)return Ma[e]=i;i=qo(i);for(let r=0;r<Vu.length;r++){const s=Vu[r]+i;if(s in n)return Ma[e]=s}return e}const Gu="http://www.w3.org/1999/xlink";function Wu(n,e,t,i,r,s=jp(e)){i&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(Gu,e.slice(6,e.length)):n.setAttributeNS(Gu,e,t):t==null||s&&!yh(t)?n.removeAttribute(e):n.setAttribute(e,s?"":wi(t)?String(t):t)}function Xu(n,e,t,i,r){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?Td(t):t);return}const s=n.tagName;if(e==="value"&&s!=="PROGRESS"&&!s.includes("-")){const a=s==="OPTION"?n.getAttribute("value")||"":n.value,l=t==null?n.type==="checkbox"?"on":"":String(t);(a!==l||!("_value"in n))&&(n.value=l),t==null&&n.removeAttribute(e),n._value=t;return}let o=!1;if(t===""||t==null){const a=typeof n[e];a==="boolean"?t=yh(t):t==null&&a==="string"?(t="",o=!0):a==="number"&&(t=0,o=!0)}try{n[e]=t}catch{}o&&n.removeAttribute(r||e)}function br(n,e,t,i){n.addEventListener(e,t,i)}function Jg(n,e,t,i){n.removeEventListener(e,t,i)}const $u=Symbol("_vei");function Qg(n,e,t,i,r=null){const s=n[$u]||(n[$u]={}),o=s[e];if(i&&o)o.value=i;else{const[a,l]=e_(e);if(i){const c=s[e]=i_(i,r);br(n,a,c,l)}else o&&(Jg(n,a,o,l),s[e]=void 0)}}const qu=/(?:Once|Passive|Capture)$/;function e_(n){let e;if(qu.test(n)){e={};let i;for(;i=n.match(qu);)n=n.slice(0,n.length-i[0].length),e[i[0].toLowerCase()]=!0}return[n[2]===":"?n.slice(3):sr(n.slice(2)),e]}let Ea=0;const t_=Promise.resolve(),n_=()=>Ea||(t_.then(()=>Ea=0),Ea=Date.now());function i_(n,e){const t=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=t.attached)return;yn(r_(i,t.value),e,5,[i])};return t.value=n,t.attached=n_(),t}function r_(n,e){if(Be(e)){const t=n.stopImmediatePropagation;return n.stopImmediatePropagation=()=>{t.call(n),n._stopped=!0},e.map(i=>r=>!r._stopped&&i&&i(r))}else return e}const Yu=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,s_=(n,e,t,i,r,s)=>{const o=r==="svg";e==="class"?$g(n,i,o):e==="style"?Kg(n,t,i):Wo(e)?yc(e)||Qg(n,e,t,i,s):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):o_(n,e,i,o))?(Xu(n,e,i),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&Wu(n,e,i,o,s,e!=="value")):n._isVueCE&&(/[A-Z]/.test(e)||!Et(i))?Xu(n,dn(e),i,s,e):(e==="true-value"?n._trueValue=i:e==="false-value"&&(n._falseValue=i),Wu(n,e,i,o))};function o_(n,e,t,i){if(i)return!!(e==="innerHTML"||e==="textContent"||e in n&&Yu(e)&&Ve(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const r=n.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return Yu(e)&&Et(t)?!1:e in n}const ju=n=>{const e=n.props["onUpdate:modelValue"]||!1;return Be(e)?t=>fo(e,t):e};function a_(n){n.target.composing=!0}function Ku(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const ba=Symbol("_assign"),l_={created(n,{modifiers:{lazy:e,trim:t,number:i}},r){n[ba]=ju(r);const s=i||r.props&&r.props.type==="number";br(n,e?"change":"input",o=>{if(o.target.composing)return;let a=n.value;t&&(a=a.trim()),s&&(a=ul(a)),n[ba](a)}),t&&br(n,"change",()=>{n.value=n.value.trim()}),e||(br(n,"compositionstart",a_),br(n,"compositionend",Ku),br(n,"change",Ku))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,oldValue:t,modifiers:{lazy:i,trim:r,number:s}},o){if(n[ba]=ju(o),n.composing)return;const a=(s||n.type==="number")&&!/^0\d/.test(n.value)?ul(n.value):n.value,l=e??"";a!==l&&(document.activeElement===n&&n.type!=="range"&&(i&&e===t||r&&n.value.trim()===l)||(n.value=l))}},c_=["ctrl","shift","alt","meta"],u_={stop:n=>n.stopPropagation(),prevent:n=>n.preventDefault(),self:n=>n.target!==n.currentTarget,ctrl:n=>!n.ctrlKey,shift:n=>!n.shiftKey,alt:n=>!n.altKey,meta:n=>!n.metaKey,left:n=>"button"in n&&n.button!==0,middle:n=>"button"in n&&n.button!==1,right:n=>"button"in n&&n.button!==2,exact:(n,e)=>c_.some(t=>n[`${t}Key`]&&!e.includes(t))},f_=(n,e)=>{const t=n._withMods||(n._withMods={}),i=e.join(".");return t[i]||(t[i]=(r,...s)=>{for(let o=0;o<e.length;o++){const a=u_[e[o]];if(a&&a(r,e))return}return n(r,...s)})},h_=Rt({patchProp:s_},kg);let Zu;function d_(){return Zu||(Zu=ag(h_))}const p_=(...n)=>{const e=d_().createApp(...n),{mount:t}=e;return e.mount=i=>{const r=g_(i);if(!r)return;const s=e._component;!Ve(s)&&!s.render&&!s.template&&(s.template=r.innerHTML),r.nodeType===1&&(r.textContent="");const o=t(r,!1,m_(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e};function m_(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function g_(n){return Et(n)?document.querySelector(n):n}const __="/logo.png",v_="/assets/logo-CuhPHO6X.png",Ml=Ko({listeners:{},emit(n,e){this.listeners[n]&&this.listeners[n].forEach(t=>t(e))},on(n,e){this.listeners[n]||(this.listeners[n]=[]),this.listeners[n].push(e)},off(n,e){this.listeners[n]&&(this.listeners[n]=this.listeners[n].filter(t=>t!==e))}}),oi=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},x_={class:"typing"},S_={__name:"Cursor",setup(n){const e=["I code","Build","Run","Ship"],t=Ht("");let i=0,r=0,s;function o(){const l=e[i];r<l.length?(t.value+=l[r],r++,s=setTimeout(o,150)):s=setTimeout(a,1e3)}function a(){r>0?(t.value=t.value.slice(0,-1),r--,s=setTimeout(a,50)):(i=(i+1)%e.length,s=setTimeout(o,150))}return Ci(()=>{o()}),ea(()=>{clearTimeout(s)}),(l,c)=>(Ze(),tt("div",x_,[xs(rn(t.value),1),c[0]||(c[0]=Xe("span",{class:"cursor"},"|",-1))]))}},y_=oi(S_,[["__scopeId","data-v-4414a491"]]),M_={class:"hero"},E_={class:"content"},b_=["src"],T_={key:0,class:"hero-title"},A_={key:0,class:"hero-subtitle"},w_={__name:"AnimatedLogo",setup(n){const e=Ht(!1);function t(){Ml.emit("open-chat")}return Ci(()=>{setTimeout(()=>{e.value=!0},300)}),(i,r)=>(Ze(),tt("section",M_,[r[1]||(r[1]=Xe("div",{class:"overlay"},null,-1)),Xe("div",E_,[gt(go,{name:"logo-fade"},{default:as(()=>[e.value?(Ze(),tt("img",{key:0,src:kh(v_),alt:"Animated Logo",class:"animated-logo",onClick:t},null,8,b_)):jn("",!0)]),_:1}),gt(go,{name:"text-slide"},{default:as(()=>[e.value?(Ze(),tt("h1",T_," Welcome to My Universe ")):jn("",!0)]),_:1}),gt(go,{name:"subtitle-fade"},{default:as(()=>[e.value?(Ze(),tt("p",A_,r[0]||(r[0]=[xs(" Where creativity meets ",-1),Xe("strong",null,"technology",-1)]))):jn("",!0)]),_:1}),gt(y_)])]))}},wd=oi(w_,[["__scopeId","data-v-7fc8a32a"]]),C_=()=>{};var Ju={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mv{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(gv(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function gv(n){return n.getComponent()?.type==="VERSION"}const Al="@firebase/app",sf="0.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jv=1024,Qv=30;class e0{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new n0(t),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=lf();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(r=>r.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:t}),this._heartbeatsCache.heartbeats.length>Qv){const r=i0(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(r,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){ni.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=lf(),{heartbeatsToSend:t,unsentEntries:i}=t0(this._heartbeatsCache.heartbeats),r=Pd(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(e){return ni.warn(e),""}}}function lf(){return new Date().toISOString().substring(0,10)}function t0(n,e=Jv){const t=[];let i=n.slice();for(const r of n){const s=t.find(o=>o.agent===r.agent);if(s){if(s.dates.push(r.date),cf(t)>e){s.dates.pop();break}}else if(t.push({agent:r.agent,dates:[r.date]}),cf(t)>e){t.pop();break}i=i.slice(1)}return{heartbeatsToSend:t,unsentEntries:i}}class n0{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return W_()?X_().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Zv(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return af(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return af(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function cf(n){return Pd(JSON.stringify({version:2,heartbeats:n})).length}function i0(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let i=1;i<n.length;i++)n[i].date<t&&(t=n[i].date,e=i);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function r0(n){No(new Ms("platform-logger",e=>new mv(e),"PRIVATE")),No(new Ms("heartbeat",e=>new e0(e),"PRIVATE")),Dr(Al,sf,n),Dr(Al,sf,"esm2020"),Dr("fire-js","")}r0("");var s0="firebase",o0="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uf={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class Yt extends Hr{constructor(e,t,i){super(`${kc}/${e}`,t||""),this.details=i,Object.setPrototypeOf(this,Yt.prototype)}}function c0(n){if(n>=200&&n<300)return"ok";switch(n){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function Oo(n,e){let t=c0(n),i=t,r;try{const s=e&&e.error;if(s){const o=s.status;if(typeof o=="string"){if(!uf[o])return new Yt("internal","internal");t=uf[o],i=o}const a=s.message;typeof a=="string"&&(i=a),r=s.details,r!==void 0&&(r=Nr(r))}}catch{}return t==="ok"?null:new Yt(t,i,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`);a=f.pop()||"";for(const h of f)h.trim()&&r(h.trim(),o);return l()}catch(c){const u=c instanceof Yt?c:Oo(0,null);o.error(u),t(u)}}},cancel(){return n.cancel()}})}const ff="@firebase/functions",hf="0.13.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const M0="auth-internal",E0="app-check-internal",b0="messaging-internal";function T0(n){const e=(t,{instanceIdentifier:i})=>{const r=t.getProvider("app").getImmediate(),s=t.getProvider(M0),o=t.getProvider(b0),a=t.getProvider(E0);return new d0(r,s,o,a,i)};No(new Ms(kc,e,"PUBLIC").setMultipleInstances(!0)),Dr(ff,hf,n),Dr(ff,hf,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gd(n=Bd(),e=Rl){const i=Xv(Oc(n),kc).getImmediate({identifier:e}),r=B_("functions");return r&&A0(i,...r),i}function A0(n,e,t){p0(Oc(n),e,t)}function w0(n,e,t){return m0(Oc(n),e)}T0();const C0={key:0,class:"chat-window"},R0={class:"prompt"},P0={key:0,class:"suggestions"},D0=["disabled"],I0={key:2,class:"loading"},L0={__name:"AiPrompt",setup(n){const e=Bd(),t=Gd(e,"europe-west1"),i=w0(t,"chatWithAI"),r=Ht(null),s=Ht(""),o=Ht([]),a=Ht(!1),l=Ht(!1),c=Ht(!0);function u(){l.value=!l.value}function f(x){s.value=x,p()}function h(){const x=["Write a short and funny story about Théophile Vast.","Make a humorous comment about Alien Computing."],m=x[Math.floor(Math.random()*x.length)];f(m)}Ci(()=>{Ml.on("open-chat",()=>{l.value=!0})}),ea(()=>{Ml.off("open-chat")});async function p(){const x=s.value.trim();if(x){o.value.push({text:x,isUser:!0}),s.value="",a.value=!0,_();try{const m=await i({prompt:x});o.value.push({text:m.data.text,isUser:!1}),_()}catch(m){o.value.push({text:`Error: ${m.message}`,isUser:!1}),_()}finally{a.value=!1}}}function _(){Vh(()=>{r.value&&(r.value.scrollTop=r.value.scrollHeight)})}return(x,m)=>(Ze(),tt("div",null,[Xe("button",{class:"fab",onClick:u},m[4]||(m[4]=[xs(" 💬 ",-1),Xe("span",{class:"tooltip"},"Chat with AI!",-1)])),l.value?(Ze(),tt("div",C0,[Xe("div",{ref_key:"terminal",ref:r,class:"terminal"},[(Ze(!0),tt(Ut,null,Po(o.value,(d,w)=>(Ze(),tt("div",{key:w,class:"line"},[Xe("span",R0,rn(d.isUser?"> ":""),1),xs(rn(d.text),1)]))),128)),c.value?(Ze(),tt("div",P0,[Xe("button",{onClick:m[0]||(m[0]=d=>h())},"Funny Théophile / Alien"),Xe("button",{onClick:m[1]||(m[1]=d=>f("Write a short poem about technology."))},"Poem"),Xe("button",{onClick:m[2]||(m[2]=d=>f("Help me prepare a quick elevator pitch."))},"Elevator Pitch")])):jn("",!0),c.value?(Ze(),tt("form",{key:1,onSubmit:f_(p,["prevent"])},[m[5]||(m[5]=Xe("span",{class:"prompt"},">",-1)),Cm(Xe("input",{"onUpdate:modelValue":m[3]||(m[3]=d=>s.value=d),placeholder:"Type your question...",autofocus:""},null,512),[[l_,s.value]]),Xe("button",{type:"submit",disabled:a.value||!s.value.trim(),style:{display:"none"}},"Send",8,D0)],32)):jn("",!0),a.value?(Ze(),tt("div",I0,"AI is thinking...")):jn("",!0)],512)])):jn("",!0)]))}},U0=oi(L0,[["__scopeId","data-v-2ba9aea4"]]),N0={name:"Timeline",props:{cv:{type:Array,required:!0}},data(){return{timeline:[]}},created(){this.loadTimeline()},methods:{loadTimeline(){this.timeline=this.cv},scroll(n){const e=this.$refs.carousel;if(!e||!e.children.length)return;const t=e.children[0].offsetWidth+16;e.scrollBy({left:n*t,behavior:"smooth"})}}},F0={class:"timeline-carousel"},O0={key:0,class:"carousel-wrapper"},B0={ref:"carousel",class:"carousel"},k0={class:"icon"},z0={class:"content"},H0={class:"title"},V0={class:"subtitle"},G0={key:0};function W0(n,e,t,i,r,s){return Ze(),tt("div",F0,[r.timeline&&r.timeline.length?(Ze(),tt("div",O0,[Xe("button",{class:"nav-btn left",onClick:e[0]||(e[0]=o=>s.scroll(-1))},"‹"),Xe("div",B0,[(Ze(!0),tt(Ut,null,Po(r.timeline,(o,a)=>(Ze(),tt("div",{key:a,class:"carousel-card"},[Xe("div",k0,rn(o.icon),1),Xe("div",z0,[Xe("h3",H0,rn(o.title),1),Xe("p",V0,rn(o.company||o.institution||"")+" - "+rn(o.date||""),1),o.description&&o.description.length?(Ze(),tt("ul",G0,[(Ze(!0),tt(Ut,null,Po(o.description,(l,c)=>(Ze(),tt("li",{key:c},rn(l),1))),128))])):jn("",!0)])]))),128))],512),Xe("button",{class:"nav-btn right",onClick:e[1]||(e[1]=o=>s.scroll(1))},"›")])):jn("",!0)])}const X0=oi(N0,[["render",W0],["__scopeId","data-v-a516013e"]]),$0=[{type:"education",title:"SUP'Internet – Bachelor's in Programming / Web Development",institution:"SUP'Internet, Montpellier",date:"2011-2013",description:["Studied full-stack web development","Built early web projects and prototypes"],icon:"🎓"},{type:"education",title:"Udemy – Node.js & React.js Development",institution:"Udemy",date:"2020",description:["Focused on JavaScript full-stack development","Enhanced skills in modern web frameworks"],icon:"📚"},{type:"job",title:"Data Architect",company:"Accenture",date:"Sep 2023 - Apr 2024",description:["Managed data workflows and architecture","Implemented scalable solutions bridging DevOps & development"],icon:"💼"},{type:"job",title:"Web Developer Specialist",company:"Accenture",date:"Jan 2022 - Sep 2023",description:["Developed features for SAP Cloud Commerce","Refactored UX/UI with Algolia technology","Trained teams on AI, Blockchain, Machine Learning","Tech: Vue.js v2, SCSS, VueX, RESTful APIs"],icon:"💻"},{type:"job",title:"Full Stack Developer",company:"Claranet France",date:"Jun 2021 - Dec 2021",description:["Optimized Vue.js v2 / Angular v12 frontend features","Worked with microservices (Socket.io & GRPC)","Improved CI/CD pipelines on GitLab"],icon:"💻"},{type:"project",title:"Quasar Speech Recognition Bot",company:"Leihia – Lead Developer",date:"Oct 2020 - Jun 2021",description:["Developed Vue.js app from scratch","Designed UX for AI-driven speech recognition","Implemented DevOps pipelines for staging & production"],icon:"🤖"},{type:"project",title:"Interactive Prototypes",company:"Amadeus – Fullstack Software Engineer",date:"Dec 2019 - May 2020",description:["Created monitoring dashboards with Adobe Analytics, SAP, Apigee","Public speaking and technical writing","Tech: React.js, Vue.js, Angular, Node.js, Elasticsearch, Kibana, SCSS"],icon:"🛠️"},{type:"job",title:"Front-End Engineer",company:"IBM Interactive",date:"Jan 2019 - Jul 2019",description:["Developed private banking loan app","Methodology: Agile Scrum","Tech: Vanilla JS, Swagger Java 8, Cucumber"],icon:"💻"},{type:"project",title:"Educational Games & E-Learning Platform",company:"Institut Français – VIA Ingénieur Web",date:"Nov 2016 - Dec 2018",description:["Developed educational games","Managed e-learning platform and cultural website features","Tech: WordPress, Moodle, JS, HTML5, CSS3"],icon:"🎮"},{type:"certification",title:"OSPG Certification",institution:"",date:"",description:[],icon:"💡"},{type:"honor",title:"Hackathon Nao Winner",institution:"",date:"",description:["Developed robot AI & interaction project"],icon:"🏆"},{type:"skillset",title:"Core Skills",description:["Intelligence Artificielle (AI)",".NET Framework","Fine Dining","Languages: English (Full), Italian (Limited), Spanish (Professional), French (Native)"],icon:"🛠️"},{type:"interest",title:"Creative & Space Projects",description:["Building immersive experiences blending AI, music, and space design","Design thinking for interactive and futuristic concepts"],icon:"🌌"}];function zc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var or=zc();function Wd(n){or=n}var ds={exec:()=>null};function it(n,e=""){let t=typeof n=="string"?n:n.source,i={replace:(r,s)=>{let o=typeof s=="string"?s:s.source;return o=o.replace(Wt.caret,"$1"),t=t.replace(r,o),i},getRegex:()=>new RegExp(t,e)};return i}var Wt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:n=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:n=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},q0=/^(?:[ \t]*(?:\n|$))+/,Y0=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,j0=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Ps=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,K0=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Hc=/(?:[*+-]|\d{1,9}[.)])/,Xd=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,$d=it(Xd).replace(/bull/g,Hc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Z0=it(Xd).replace(/bull/g,Hc).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Vc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,J0=/^[^\n]+/,Gc=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Q0=it(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Gc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ex=it(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Hc).getRegex(),ra="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Wc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,tx=it("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Wc).replace("tag",ra).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),qd=it(Vc).replace("hr",Ps).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ra).getRegex(),nx=it(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",qd).getRegex(),Xc={blockquote:nx,code:Y0,def:Q0,fences:j0,heading:K0,hr:Ps,html:tx,lheading:$d,list:ex,newline:q0,paragraph:qd,table:ds,text:J0},df=it("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Ps).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ra).getRegex(),ix={...Xc,lheading:Z0,table:df,paragraph:it(Vc).replace("hr",Ps).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",df).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ra).getRegex()},rx={...Xc,html:it(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Wc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ds,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:it(Vc).replace("hr",Ps).replace("heading",` *#{1,6} *[^
]`).replace("lheading",$d).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},sx=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ox=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Yd=/^( {2,}|\\)\n(?!\s*$)/,ax=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,sa=/[\p{P}\p{S}]/u,$c=/[\s\p{P}\p{S}]/u,jd=/[^\s\p{P}\p{S}]/u,lx=it(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,$c).getRegex(),Kd=/(?!~)[\p{P}\p{S}]/u,cx=/(?!~)[\s\p{P}\p{S}]/u,ux=/(?:[^\s\p{P}\p{S}]|~)/u,fx=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,Zd=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,hx=it(Zd,"u").replace(/punct/g,sa).getRegex(),dx=it(Zd,"u").replace(/punct/g,Kd).getRegex(),Jd="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",px=it(Jd,"gu").replace(/notPunctSpace/g,jd).replace(/punctSpace/g,$c).replace(/punct/g,sa).getRegex(),mx=it(Jd,"gu").replace(/notPunctSpace/g,ux).replace(/punctSpace/g,cx).replace(/punct/g,Kd).getRegex(),gx=it("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,jd).replace(/punctSpace/g,$c).replace(/punct/g,sa).getRegex(),_x=it(/\\(punct)/,"gu").replace(/punct/g,sa).getRegex(),vx=it(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),xx=it(Wc).replace("(?:-->|$)","-->").getRegex(),Sx=it("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",xx).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Bo=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,yx=it(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Bo).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Qd=it(/^!?\[(label)\]\[(ref)\]/).replace("label",Bo).replace("ref",Gc).getRegex(),ep=it(/^!?\[(ref)\](?:\[\])?/).replace("ref",Gc).getRegex(),Mx=it("reflink|nolink(?!\\()","g").replace("reflink",Qd).replace("nolink",ep).getRegex(),qc={_backpedal:ds,anyPunctuation:_x,autolink:vx,blockSkip:fx,br:Yd,code:ox,del:ds,emStrongLDelim:hx,emStrongRDelimAst:px,emStrongRDelimUnd:gx,escape:sx,link:yx,nolink:ep,punctuation:lx,reflink:Qd,reflinkSearch:Mx,tag:Sx,text:ax,url:ds},Ex={...qc,link:it(/^!?\[(label)\]\((.*?)\)/).replace("label",Bo).getRegex(),reflink:it(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Bo).getRegex()},Pl={...qc,emStrongRDelimAst:mx,emStrongLDelim:dx,url:it(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},bx={...Pl,br:it(Yd).replace("{2,}","*").getRegex(),text:it(Pl.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Hs={normal:Xc,gfm:ix,pedantic:rx},Yr={normal:qc,gfm:Pl,breaks:bx,pedantic:Ex},Tx={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},pf=n=>Tx[n];function bn(n,e){if(e){if(Wt.escapeTest.test(n))return n.replace(Wt.escapeReplace,pf)}else if(Wt.escapeTestNoEncode.test(n))return n.replace(Wt.escapeReplaceNoEncode,pf);return n}function mf(n){try{n=encodeURI(n).replace(Wt.percentDecode,"%")}catch{return null}return n}function gf(n,e){let t=n.replace(Wt.findPipe,(s,o,a)=>{let l=!1,c=o;for(;--c>=0&&a[c]==="\\";)l=!l;return l?"|":" |"}),i=t.split(Wt.splitPipe),r=0;if(i[0].trim()||i.shift(),i.length>0&&!i.at(-1)?.trim()&&i.pop(),e)if(i.length>e)i.splice(e);else for(;i.length<e;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(Wt.slashPipe,"|");return i}function jr(n,e,t){let i=n.length;if(i===0)return"";let r=0;for(;r<i&&n.charAt(i-r-1)===e;)r++;return n.slice(0,i-r)}function Ax(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let i=0;i<n.length;i++)if(n[i]==="\\")i++;else if(n[i]===e[0])t++;else if(n[i]===e[1]&&(t--,t<0))return i;return t>0?-2:-1}function _f(n,e,t,i,r){let s=e.href,o=e.title||null,a=n[1].replace(r.other.outputLinkReplace,"$1");i.state.inLink=!0;let l={type:n[0].charAt(0)==="!"?"image":"link",raw:t,href:s,title:o,text:a,tokens:i.inlineTokens(a)};return i.state.inLink=!1,l}function wx(n,e,t){let i=n.match(t.other.indentCodeCompensation);if(i===null)return e;let r=i[1];return e.split(`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function Jf(){return new ri({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:au(),fragmentShader:`
		...
		`,blending:Mi,depthTest:!1,depthWrite:!1})}function Qf(){return new ri({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:au(),fragmentShader:`
...
}`;class tA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Dp(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new ri({vertexShader:QT,fragmentShader:eA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Pn(new la(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class nA extends Vr{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,f=null,h=null,p=null,_=null;const x=new tA,m={},d=t.getContextAttributes();let w=null,T=null;const S=[],R=[],D=new Je;let P=null;const U=new nn;U.viewport=new lt;const E=new nn;E.viewport=new lt;const b=[U,E],C=new vy;let O=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(te){let de=S[te];return de===void 0&&(de=new Za,S[te]=de),de.getTargetRaySpace()},this.getControllerGrip=function(te){let de=S[te];return de===void 0&&(de=new Za,S[te]=de),de.getGripSpace()},this.getHand=function(te){let de=S[te];return de===void 0&&(de=new Za,S[te]=de),de.getHandSpace()};function K(te){const de=R.indexOf(te.inputSource);if(de===-1)return;const fe=S[de];fe!==void 0&&(fe.update(te.inputSource,te.frame,c||o),fe.dispatchEvent({type:te.type,data:te.inputSource}))}function ne(){r.removeEventListener("select",K),r.removeEventListener("selectstart",K),r.removeEventListener("selectend",K),r.removeEventListener("squeeze",K),r.removeEventListener("squeezestart",K),r.removeEventListener("squeezeend",K),r.removeEventListener("end",ne),r.removeEventListener("inputsourceschange",Z);for(let te=0;te<S.length;te++){const de=R[te];de!==null&&(R[te]=null,S[te].disconnect(de))}O=null,W=null,x.reset();for(const te in m)delete m[te];e.setRenderTarget(w),p=null,h=null,f=null,r=null,T=null,rt.stop(),i.isPresenting=!1,e.setPixelRatio(P),e.setSize(D.width,D.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(te){s=te,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(te){a=te,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(te){c=te},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(te){if(r=te,r!==null){if(w=e.getRenderTarget(),r.addEventListener("select",K),r.addEventListener("selectstart",K),r.addEventListener("selectend",K),r.addEventListener("squeeze",K),r.addEventListener("squeezestart",K),r.addEventListener("squeezeend",K),r.addEventListener("end",ne),r.addEventListener("inputsourceschange",Z),d.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(D),typeof XRWebGLBinding<"u"&&(f=new XRWebGLBinding(r,t)),f!==null&&"createProjectionLayer"in XRWebGLBinding.prototype){let fe=null,De=null,Le=null;d.depth&&(Le=d.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,fe=d.stencil?ws:As,De=d.stencil?Ts:ir);const Fe={colorFormat:t.RGBA8,depthFormat:Le,scaleFactor:s};h=f.createProjectionLayer(Fe),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),T=new rr(h.textureWidth,h.textureHeight,{format:vn,type:Un,depthTexture:new Ep(h.textureWidth,h.textureHeight,De,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:d.stencil,colorSpace:e.outputColorSpace,samples:d.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const fe={antialias:d.antialias,alpha:!0,depth:d.depth,stencil:d.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,fe),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),T=new rr(p.framebufferWidth,p.framebufferHeight,{format:vn,type:Un,colorSpace:e.outputColorSpace,stencilBuffer:d.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),rt.setContext(r),rt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function Z(te){for(let de=0;de<te.removed.length;de++){const fe=te.removed[de],De=R.indexOf(fe);De>=0&&(R[De]=null,S[De].disconnect(fe))}for(let de=0;de<te.added.length;de++){const fe=te.added[de];let De=R.indexOf(fe);if(De===-1){for(let Fe=0;Fe<S.length;Fe++)if(Fe>=R.length){R.push(fe),De=Fe;break}else if(R[Fe]===null){R[Fe]=fe,De=Fe;break}if(De===-1)break}const Le=S[De];Le&&Le.connect(fe)}}const Q=new B,k=new B;function he(te,de,fe){Q.setFromMatrixPosition(de.matrixWorld),k.setFromMatrixPosition(fe.matrixWorld);const De=Q.distanceTo(k),Le=de.projectionMatrix.elements,Fe=fe.projectionMatrix.elements,St=Le[14]/(Le[10]-1),A=Le[14]/(Le[10]+1),v=(Le[9]+1)/Le[5],H=(Le[9]-1)/Le[5],X=(Le[8]-1)/Le[0],j=(Fe[8]+1)/Fe[0],G=St*X,se=St*j,q=De/(-X+j),ee=q*-X;if(de.matrixWorld.decompose(te.position,te.quaternion,te.scale),te.translateX(ee),te.translateZ(q),te.matrixWorld.compose(te.position,te.quaternion,te.scale),te.matrixWorldInverse.copy(te.matrixWorld).invert(),Le[10]===-1)te.projectionMatrix.copy(de.projectionMatrix),te.projectionMatrixInverse.copy(de.projectionMatrixInverse);else{const ie=St+q,ge=A+q,y=G-ee,g=se+(De-ee),I=v*A/ge*ie,z=H*A/ge*ie;te.projectionMatrix.makePerspective(y,g,I,z,ie,ge),te.projectionMatrixInverse.copy(te.projectionMatrix).invert()}}function xe(te,de){de===null?te.matrixWorld.copy(te.matrix):te.matrixWorld.multiplyMatrices(de.matrixWorld,te.matrix),te.matrixWorldInverse.copy(te.matrixWorld).invert()}this.updateCamera=function(te){if(r===null)return;let de=te.near,fe=te.far;x.texture!==null&&(x.depthNear>0&&(de=x.depthNear),x.depthFar>0&&(fe=x.depthFar)),C.near=E.near=U.near=de,C.far=E.far=U.far=fe,(O!==C.near||W!==C.far)&&(r.updateRenderState({depthNear:C.near,depthFar:C.far}),O=C.near,W=C.far),C.layers.mask=te.layers.mask|6,U.layers.mask=C.layers.mask&3,E.layers.mask=C.layers.mask&5;const De=te.parent,Le=C.cameras;xe(C,De);for(let Fe=0;Fe<Le.length;Fe++)xe(Le[Fe],De);Le.length===2?he(C,U,E):C.projectionMatrix.copy(U.projectionMatrix),Ce(te,C,De)};function Ce(te,de,fe){fe===null?te.matrix.copy(de.matrixWorld):(te.matrix.copy(fe.matrixWorld),te.matrix.invert(),te.matrix.multiply(de.matrixWorld)),te.matrix.decompose(te.position,te.quaternion,te.scale),te.updateMatrixWorld(!0),te.projectionMatrix.copy(de.projectionMatrix),te.projectionMatrixInverse.copy(de.projectionMatrixInverse),te.isPerspectiveCamera&&(te.fov=vc*2*Math.atan(1/te.projectionMatrix.elements[5]),te.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(te){l=te,h!==null&&(h.fixedFoveation=te),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=te)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(C)},this.getCameraTexture=function(te){return m[te]};let Ne=null;function ct(te,de){if(u=de.getViewerPose(c||o),_=de,u!==null){const fe=u.views;p!==null&&(e.setRenderTargetFramebuffer(T,p.framebuffer),e.setRenderTarget(T));let De=!1;fe.length!==C.cameras.length&&(C.cameras.length=0,De=!0);for(let A=0;A<fe.length;A++){const v=fe[A];let H=null;if(p!==null)H=p.getViewport(v);else{const j=f.getViewSubImage(h,v);H=j.viewport,A===0&&(e.setRenderTargetTextures(T,j.colorTexture,j.depthStencilTexture),e.setRenderTarget(T))}let X=b[A];X===void 0&&(X=new nn,X.layers.enable(A),X.viewport=new lt,b[A]=X),X.matrix.fromArray(v.transform.matrix),X.matrix.decompose(X.position,X.quaternion,X.scale),X.projectionMatrix.fromArray(v.projectionMatrix),X.projectionMatrixInverse.copy(X.projectionMatrix).invert(),X.viewport.set(H.x,H.y,H.width,H.height),A===0&&(C.matrix.copy(X.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),De===!0&&C.cameras.push(X)}const Le=r.enabledFeatures;if(Le&&Le.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&f){const A=f.getDepthInformation(fe[0]);A&&A.isValid&&A.texture&&x.init(A,r.renderState)}if(Le&&Le.includes("camera-access")&&(e.state.unbindTexture(),f))for(let A=0;A<fe.length;A++){const v=fe[A].camera;if(v){let H=m[v];H||(H=new Dp,m[v]=H);const X=f.getCameraImage(v);H.sourceTexture=X}}}for(let fe=0;fe<S.length;fe++){const De=R[fe],Le=S[fe];De!==null&&Le!==void 0&&Le.update(De,de,c||o)}Ne&&Ne(te,de),de.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:de}),_=null}const rt=new Ap;rt.setAnimationLoop(ct),this.setAnimationLoop=function(te){Ne=te},this.dispose=function(){}}}const Wi=new ii,iA=new Mt;function rA(n,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function i(m,d){d.color.getRGB(m.fogColor.value,Sp(n)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,w,T,S){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),f(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),h(m,d),d.isMeshPhysicalMaterial&&p(m,d,S)):d.isMeshMatcapMaterial?(s(m,d),_(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),x(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(o(m,d),d.isLineDashedMaterial&&a(m,d)):d.isPointsMaterial?l(m,d,w,T):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===jt&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===jt&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const w=e.get(d),T=w.envMap,S=w.envMapRotation;T&&(m.envMap.value=T,Wi.copy(S),Wi.x*=-1,Wi.y*=-1,Wi.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(Wi.y*=-1,Wi.z*=-1),m.envMapRotation.value.setFromMatrix4(iA.makeRotationFromEuler(Wi)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function o(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function a(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,w,T){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*w,m.scale.value=T*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function f(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function h(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,w){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===jt&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function x(m,d){const w=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function sA(n,e,t,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,T){const S=T.program;i.uniformBlockBinding(w,S)}function c(w,T){let S=r[w.id];S===void 0&&(_(w),S=u(w),r[w.id]=S,w.addEventListener("dispose",m));const R=T.program;i.updateUBOMapping(w,R);const D=e.render.frame;s[w.id]!==D&&(h(w),s[w.id]=D)}function u(w){const T=f();w.__bindingPointIndex=T;const S=n.createBuffer(),R=w.__size,D=w.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,R,D),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,T,S),S}function f(){for(let w=0;w<a;w++)if(o.indexOf(w)===-1)return o.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(w){const T=r[w.id],S=w.uniforms,R=w.__cache;n.bindBuffer(n.UNIFORM_BUFFER,T);for(let D=0,P=S.length;D<P;D++){const U=Array.isArray(S[D])?S[D]:[S[D]];for(let E=0,b=U.length;E<b;E++){const C=U[E];if(p(C,D,E,R)===!0){const O=C.__offset,W=Array.isArray(C.value)?C.value:[C.value];let K=0;for(let ne=0;ne<W.length;ne++){const Z=W[ne],Q=x(Z);typeof Z=="number"||typeof Z=="boolean"?(C.__data[0]=Z,n.bufferSubData(n.UNIFORM_BUFFER,O+K,C.__data)):Z.isMatrix3?(C.__data[0]=Z.elements[0],C.__data[1]=Z.elements[1],C.__data[2]=Z.elements[2],C.__data[3]=0,C.__data[4]=Z.elements[3],C.__data[5]=Z.elements[4],C.__data[6]=Z.elements[5],C.__data[7]=0,C.__data[8]=Z.elements[6],C.__data[9]=Z.elements[7],C.__data[10]=Z.elements[8],C.__data[11]=0):(Z.toArray(C.__data,K),K+=Q.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,O,C.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(w,T,S,R){const D=w.value,P=T+"_"+S;if(R[P]===void 0)return typeof D=="number"||typeof D=="boolean"?R[P]=D:R[P]=D.clone(),!0;{const U=R[P];if(typeof D=="number"||typeof D=="boolean"){if(U!==D)return R[P]=D,!0}else if(U.equals(D)===!1)return U.copy(D),!0}return!1}function _(w){const T=w.uniforms;let S=0;const R=16;for(let P=0,U=T.length;P<U;P++){const E=Array.isArray(T[P])?T[P]:[T[P]];for(let b=0,C=E.length;b<C;b++){const O=E[b],W=Array.isArray(O.value)?O.value:[O.value];for(let K=0,ne=W.length;K<ne;K++){const Z=W[K],Q=x(Z),k=S%R,he=k%Q.boundary,xe=k+he;S+=he,xe!==0&&R-xe<Q.storage&&(S+=R-xe),O.__data=new Float32Array(Q.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=S,S+=Q.storage}}}const D=S%R;return D>0&&(S+=R-D),w.__size=S,w.__cache={},this}function x(w){const T={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(T.boundary=4,T.storage=4):w.isVector2?(T.boundary=8,T.storage=8):w.isVector3||w.isColor?(T.boundary=16,T.storage=12):w.isVector4?(T.boundary=16,T.storage=16):w.isMatrix3?(T.boundary=48,T.storage=48):w.isMatrix4?(T.boundary=64,T.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),T}function m(w){const T=w.target;T.removeEventListener("dispose",m);const S=o.indexOf(T.__bindingPointIndex);o.splice(S,1),n.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function d(){for(const w in r)n.deleteBuffer(r[w]);o=[],r={},s={}}return{bind:l,update:c,dispose:d}}class oA{constructor(e={}){const{canvas:t=RS(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const _=new Uint32Array(4),x=new Int32Array(4);let m=null,d=null;const w=[],T=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ei,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const S=this;let R=!1;this._outputColorSpace=fn;let D=0,P=0,U=null,E=-1,b=null;const C=new lt,O=new lt;let W=null;const K=new nt(0);let ne=0,Z=t.width,Q=t.height,k=1,he=null,xe=null;const Ce=new lt(0,0,Z,Q),Ne=new lt(0,0,Z,Q);let ct=!1;const rt=new ru;let te=!1,de=!1;const fe=new Mt,De=new B,Le=new lt,Fe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let St=!1;function A(){return U===null?k:1}let v=i;function H(M,N){return t.getContext(M,N)}try{const M={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${jc}`),t.addEventListener("webglcontextlost",pe,!1),t.addEventListener("webglcontextrestored",Ae,!1),t.addEventListener("webglcontextcreationerror",le,!1),v===null){const N="webgl2";if(v=H(N,M),v===null)throw H(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let X,j,G,se,q,ee,ie,ge,y,g,I,z,J,V,ye,oe,Me,Ee,ae,ve,we,be,me,ze;function L(){X=new gb(v),X.init(),be=new JT(v,X),j=new cb(v,X,e,be),G=new KT(v,X),j.reversedDepthBuffer&&h&&G.buffers.depth.setReversed(!0),se=new xb(v),q=new OT,ee=new ZT(v,X,G,q,j,be,se),ie=new fb(S),ge=new mb(S),y=new Ty(v),me=new ab(v,y),g=new _b(v,y,se,me),I=new yb(v,g,y,se),ae=new Sb(v,j,ee),oe=new ub(q),z=new FT(S,ie,ge,X,j,me,oe),J=new rA(S,q),V=new kT,ye=new XT(X),Ee=new ob(S,ie,ge,G,I,p,l),Me=new YT(S,I,j),ze=new sA(v,se,j,G),ve=new lb(v,X,se),we=new vb(v,X,se),se.programs=z.programs,S.capabilities=j,S.extensions=X,S.properties=q,S.renderLists=V,S.shadowMap=Me,S.state=G,S.info=se}L();const ue=new nA(S,v);this.xr=ue,this.getContext=function(){return v},this.getContextAttributes=function(){return v.getContextAttributes()},this.forceContextLoss=function(){const M=X.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=X.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return k},this.setPixelRatio=function(M){M!==void 0&&(k=M,this.setSize(Z,Q,!1))},this.getSize=function(M){return M.set(Z,Q)},this.setSize=function(M,N,$=!0){if(ue.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Z=M,Q=N,t.width=Math.floor(M*k),t.height=Math.floor(N*k),$===!0&&(t.style.width=M+"px",t.style.height=N+"px"),this.setViewport(0,0,M,N)},this.getDrawingBufferSize=function(M){return M.set(Z*k,Q*k).floor()},this.setDrawingBufferSize=function(M,N,$){Z=M,Q=N,k=$,t.width=Math.floor(M*$),t.height=Math.floor(N*$),this.setViewport(0,0,M,N)},this.getCurrentViewport=function(M){return M.copy(C)},this.getViewport=function(M){return M.copy(Ce)},this.setViewport=function(M,N,$,Y){M.isVector4?Ce.set(M.x,M.y,M.z,M.w):Ce.set(M,N,$,Y),G.viewport(C.copy(Ce).multiplyScalar(k).round())},this.getScissor=function(M){return M.copy(Ne)},this.setScissor=function(M,N,$,Y){M.isVector4?Ne.set(M.x,M.y,M.z,M.w):Ne.set(M,N,$,Y),G.scissor(O.copy(Ne).multiplyScalar(k).round())},this.getScissorTest=function(){return ct},this.setScissorTest=function(M){G.setScissorTest(ct=M)},this.setOpaqueSort=function(M){he=M},this.setTransparentSort=function(M){xe=M},this.getClearColor=function(M){return M.copy(Ee.getClearColor())},this.setClearColor=function(){Ee.setClearColor(...arguments)},this.getClearAlpha=function(){return Ee.getClearAlpha()},this.setClearAlpha=function(){Ee.setClearAlpha(...arguments)},this.clear=function(M=!0,N=!0,$=!0){let Y=0;if(M){let F=!1;if(U!==null){const ce=U.texture.format;F=ce===tu||ce===eu||ce===Qc}if(F){const ce=U.texture.type,Se=ce===Un||ce===ir||ce===bs||ce===Ts||ce===Zc||ce===Jc,Re=Ee.getClearColor(),Te=Ee.getClearAlpha(),Oe=Re.r,ke=Re.g,Ie=Re.b;Se?(_[0]=Oe,_[1]=ke,_[2]=Ie,_[3]=Te,v.clearBufferuiv(v.COLOR,0,_)):(x[0]=Oe,x[1]=ke,x[2]=Ie,x[3]=Te,v.clearBufferiv(v.COLOR,0,x))}else Y|=v.COLOR_BUFFER_BIT}N&&(Y|=v.DEPTH_BUFFER_BIT),$&&(Y|=v.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),v.clear(Y)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",pe,!1),t.removeEventListener("webglcontextrestored",Ae,!1),t.removeEventListener("webglcontextcreationerror",le,!1),Ee.dispose(),V.dispose(),ye.dispose(),q.dispose(),ie.dispose(),ge.dispose(),I.dispose(),me.dispose(),ze.dispose(),z.dispose(),ue.dispose(),ue.removeEventListener("sessionstart",Mn),ue.removeEventListener("sessionend",lu),Pi.stop()};function pe(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function Ae(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;const M=se.autoReset,N=Me.enabled,$=Me.autoUpdate,Y=Me.needsUpdate,F=Me.type;L(),se.autoReset=M,Me.enabled=N,Me.autoUpdate=$,Me.needsUpdate=Y,Me.type=F}function le(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function re(M){const N=M.target;N.removeEventListener("dispose",re),Pe(N)}function Pe(M){He(M),q.remove(M)}function He(M){const N=q.get(M).programs;N!==void 0&&(N.forEach(function($){z.releaseProgram($)}),M.isShaderMaterial&&z.releaseShaderCache(M))}this.renderBufferDirect=function(M,N,$,Y,F,ce){N===null&&(N=Fe);const Se=F.isMesh&&F.matrixWorld.determinant()<0,Re=Ip(M,N,$,Y,F);G.setMaterial(Y,Se);let Te=$.index,Oe=1;if(Y.wireframe===!0){if(Te=g.getWireframeAttribute($),Te===void 0)return;Oe=2}const ke=$.drawRange,Ie=$.attributes.position;let $e=ke.start*Oe,ot=(ke.start+ke.count)*Oe;ce!==null&&($e=Math.max($e,ce.start*Oe),ot=Math.min(ot,(ce.start+ce.count)*Oe)),Te!==null?($e=Math.max($e,0),ot=Math.min(ot,Te.count)):Ie!=null&&($e=Math.max($e,0),ot=Math.min(ot,Ie.count));const yt=ot-$e;if(yt<0||yt===1/0)return;me.setup(F,Y,Re,$,Te);let pt,ut=ve;if(Te!==null&&(pt=y.get(Te),ut=we,ut.setIndex(pt)),F.isMesh)Y.wireframe===!0?(G.setLineWidth(Y.wireframeLinewidth*A()),ut.setMode(v.LINES)):ut.setMode(v.TRIANGLES);else if(F.isLine){let Ue=Y.linewidth;Ue===void 0&&(Ue=1),G.setLineWidth(Ue*A()),F.isLineSegments?ut.setMode(v.LINES):F.isLineLoop?ut.setMode(v.LINE_LOOP):ut.setMode(v.LINE_STRIP)}else F.isPoints?ut.setMode(v.POINTS):F.isSprite&&ut.setMode(v.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)Lr("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ut.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(X.get("WEBGL_multi_draw"))ut.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Ue=F._multiDrawStarts,vt=F._multiDrawCounts,Ye=F._multiDrawCount,Zt=Te?y.get(Te).bytesPerElement:1,ar=q.get(Y).currentProgram.getUniforms();for(let Jt=0;Jt<Ye;Jt++)ar.setValue(v,"_gl_DrawID",Jt),ut.render(Ue[Jt]/Zt,vt[Jt])}else if(F.isInstancedMesh)ut.renderInstances($e,yt,F.count);else if($.isInstancedBufferGeometry){const Ue=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,vt=Math.min($.instanceCount,Ue);ut.renderInstances($e,yt,vt)}else ut.render($e,yt)};function ht(M,N,$){M.transparent===!0&&M.side===Yn&&M.forceSinglePass===!1?(M.side=jt,M.needsUpdate=!0,Fs(M,N,$),M.side=Ai,M.needsUpdate=!0,Fs(M,N,$),M.side=Yn):Fs(M,N,$)}this.compile=function(M,N,$=null){$===null&&($=M),d=ye.get($),d.init(N),T.push(d),$.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(d.pushLight(F),F.castShadow&&d.pushShadow(F))}),M!==$&&M.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(d.pushLight(F),F.castShadow&&d.pushShadow(F))}),d.setupLights();const Y=new Set;return M.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;const ce=F.material;if(ce)if(Array.isArray(ce))for(let Se=0;Se<ce.length;Se++){const Re=ce[Se];ht(Re,$,F),Y.add(Re)}else ht(ce,$,F),Y.add(ce)}),d=T.pop(),Y},this.compileAsync=function(M,N,$=null){const Y=this.compile(M,N,$);return new Promise(F=>{function ce(){if(Y.forEach(function(Se){q.get(Se).currentProgram.isReady()&&Y.delete(Se)}),Y.size===0){F(M);return}setTimeout(ce,10)}X.get("KHR_parallel_shader_compile")!==null?ce():setTimeout(ce,10)})};let Qe=null;function Nn(M){Qe&&Qe(M)}function Mn(){Pi.stop()}function lu(){Pi.start()}const Pi=new Ap;Pi.setAnimationLoop(Nn),typeof self<"u"&&Pi.setContext(self),this.setAnimationLoop=function(M){Qe=M,ue.setAnimationLoop(M),M===null?Pi.stop():Pi.start()},ue.addEventListener("sessionstart",Mn),ue.addEventListener("sessionend",lu),this.render=function(M,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),ue.enabled===!0&&ue.isPresenting===!0&&(ue.cameraAutoUpdate===!0&&ue.updateCamera(N),N=ue.getCamera()),M.isScene===!0&&M.onBeforeRender(S,M,N,U),d=ye.get(M,T.length),d.init(N),T.push(d),fe.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),rt.setFromProjectionMatrix(fe,Rn,N.reversedDepth),de=this.localClippingEnabled,te=oe.init(this.clippingPlanes,de),m=V.get(M,w.length),m.init(),w.push(m),ue.enabled===!0&&ue.isPresenting===!0){const ce=S.xr.getDepthSensingMesh();ce!==null&&ua(ce,N,-1/0,S.sortObjects)}ua(M,N,0,S.sortObjects),m.finish(),S.sortObjects===!0&&m.sort(he,xe),St=ue.enabled===!1||ue.isPresenting===!1||ue.hasDepthSensing()===!1,St&&Ee.addToRenderList(m,M),this.info.render.frame++,te===!0&&oe.beginShadows();const $=d.state.shadowsArray;Me.render($,M,N),te===!0&&oe.endShadows(),this.info.autoReset===!0&&this.info.reset();const Y=m.opaque,F=m.transmissive;if(d.setupLights(),N.isArrayCamera){const ce=N.cameras;if(F.length>0)for(let Se=0,Re=ce.length;Se<Re;Se++){const Te=ce[Se];uu(Y,F,M,Te)}St&&Ee.render(M);for(let Se=0,Re=ce.length;Se<Re;Se++){const Te=ce[Se];cu(m,M,Te,Te.viewport)}}else F.length>0&&uu(Y,F,M,N),St&&Ee.render(M),cu(m,M,N);U!==null&&P===0&&(ee.updateMultisampleRenderTarget(U),ee.updateRenderTargetMipmap(U)),M.isScene===!0&&M.onAfterRender(S,M,N),me.resetDefaultState(),E=-1,b=null,T.pop(),T.length>0?(d=T[T.length-1],te===!0&&oe.setGlobalState(S.clippingPlanes,d.state.camera)):d=null,w.pop(),w.length>0?m=w[w.length-1]:m=null};function ua(M,N,$,Y){if(M.visible===!1)return;if(M.layers.test(N.layers)){if(M.isGroup)$=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(N);else if(M.isLight)d.pushLight(M),M.castShadow&&d.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||rt.intersectsSprite(M)){Y&&Le.setFromMatrixPosition(M.matrixWorld).applyMatrix4(fe);const Se=I.update(M),Re=M.material;Re.visible&&m.push(M,Se,Re,$,Le.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||rt.intersectsObject(M))){const Se=I.update(M),Re=M.material;if(Y&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Le.copy(M.boundingSphere.center)):(Se.boundingSphere===null&&Se.computeBoundingSphere(),Le.copy(Se.boundingSphere.center)),Le.applyMatrix4(M.matrixWorld).applyMatrix4(fe)),Array.isArray(Re)){const Te=Se.groups;for(let Oe=0,ke=Te.length;Oe<ke;Oe++){const Ie=Te[Oe],$e=Re[Ie.materialIndex];$e&&$e.visible&&m.push(M,Se,$e,$,Le.z,Ie)}}else Re.visible&&m.push(M,Se,Re,$,Le.z,null)}}const ce=M.children;for(let Se=0,Re=ce.length;Se<Re;Se++)ua(ce[Se],N,$,Y)}function cu(M,N,$,Y){const F=M.opaque,ce=M.transmissive,Se=M.transparent;d.setupLightsView($),te===!0&&oe.setGlobalState(S.clippingPlanes,$),Y&&G.viewport(C.copy(Y)),F.length>0&&Ns(F,N,$),ce.length>0&&Ns(ce,N,$),Se.length>0&&Ns(Se,N,$),G.buffers.depth.setTest(!0),G.buffers.depth.setMask(!0),G.buffers.color.setMask(!0),G.setPolygonOffset(!1)}function uu(M,N,$,Y){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[Y.id]===void 0&&(d.state.transmissionRenderTarget[Y.id]=new rr(1,1,{generateMipmaps:!0,type:X.has("EXT_color_buffer_half_float")||X.has("EXT_color_buffer_float")?Ds:Un,minFilter:er,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:je.workingColorSpace}));const ce=d.state.transmissionRenderTarget[Y.id],Se=Y.viewport||C;ce.setSize(Se.z*S.transmissionResolutionScale,Se.w*S.transmissionResolutionScale);const Re=S.getRenderTarget(),Te=S.getActiveCubeFace(),Oe=S.getActiveMipmapLevel();S.setRenderTarget(ce),S.getClearColor(K),ne=S.getClearAlpha(),ne<1&&S.setClearColor(16777215,.5),S.clear(),St&&Ee.render($);const ke=S.toneMapping;S.toneMapping=Ei;const Ie=Y.viewport;if(Y.viewport!==void 0&&(Y.viewport=void 0),d.setupLightsView(Y),te===!0&&oe.setGlobalState(S.clippingPlanes,Y),Ns(M,$,Y),ee.updateMultisampleRenderTarget(ce),ee.updateRenderTargetMipmap(ce),X.has("WEBGL_multisampled_render_to_texture")===!1){let $e=!1;for(let ot=0,yt=N.length;ot<yt;ot++){const pt=N[ot],ut=pt.object,Ue=pt.geometry,vt=pt.material,Ye=pt.group;if(vt.side===Yn&&ut.layers.test(Y.layers)){const Zt=vt.side;vt.side=jt,vt.needsUpdate=!0,fu(ut,$,Y,Ue,vt,Ye),vt.side=Zt,vt.needsUpdate=!0,$e=!0}}$e===!0&&(ee.updateMultisampleRenderTarget(ce),ee.updateRenderTargetMipmap(ce))}S.setRenderTarget(Re,Te,Oe),S.setClearColor(K,ne),Ie!==void 0&&(Y.viewport=Ie),S.toneMapping=ke}function Ns(M,N,$){const Y=N.isScene===!0?N.overrideMaterial:null;for(let F=0,ce=M.length;F<ce;F++){const Se=M[F],Re=Se.object,Te=Se.geometry,Oe=Se.group;let ke=Se.material;ke.allowOverride===!0&&Y!==null&&(ke=Y),Re.layers.test($.layers)&&fu(Re,N,$,Te,ke,Oe)}}function fu(M,N,$,Y,F,ce){M.onBeforeRender(S,N,$,Y,F,ce),M.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),F.onBeforeRender(S,N,$,Y,M,ce),F.transparent===!0&&F.side===Yn&&F.forceSinglePass===!1?(F.side=jt,F.needsUpdate=!0,S.renderBufferDirect($,N,Y,F,M,ce),F.side=Ai,F.needsUpdate=!0,S.renderBufferDirect($,N,Y,F,M,ce),F.side=Yn):S.renderBufferDirect($,N,Y,F,M,ce),M.onAfterRender(S,N,$,Y,F,ce)}function Fs(M,N,$){N.isScene!==!0&&(N=Fe);const Y=q.get(M),F=d.state.lights,ce=d.state.shadowsArray,Se=F.state.version,Re=z.getParameters(M,F.state,ce,N,$),Te=z.getProgramCacheKey(Re);let Oe=Y.programs;Y.environment=M.isMeshStandardMaterial?N.environment:null,Y.fog=N.fog,Y.envMap=(M.isMeshStandardMaterial?ge:ie).get(M.envMap||Y.environment),Y.envMapRotation=Y.environment!==null&&M.envMap===null?N.environmentRotation:M.envMapRotation,Oe===void 0&&(M.addEventListener("dispose",re),Oe=new Map,Y.programs=Oe);let ke=Oe.get(Te);if(ke!==void 0){if(Y.currentProgram===ke&&Y.lightsStateVersion===Se)return du(M,Re),ke}else Re.uniforms=z.getUniforms(M),M.onBeforeCompile(Re,S),ke=z.acquireProgram(Re,Te),Oe.set(Te,ke),Y.uniforms=Re.uniforms;const Ie=Y.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Ie.clippingPlanes=oe.uniform),du(M,Re),Y.needsLights=Up(M),Y.lightsStateVersion=Se,Y.needsLights&&(Ie.ambientLightColor.value=F.state.ambient,Ie.lightProbe.value=F.state.probe,Ie.directionalLights.value=F.state.directional,Ie.directionalLightShadows.value=F.state.directionalShadow,Ie.spotLights.value=F.state.spot,Ie.spotLightShadows.value=F.state.spotShadow,Ie.rectAreaLights.value=F.state.rectArea,Ie.ltc_1.value=F.state.rectAreaLTC1,Ie.ltc_2.value=F.state.rectAreaLTC2,Ie.pointLights.value=F.state.point,Ie.pointLightShadows.value=F.state.pointShadow,Ie.hemisphereLights.value=F.state.hemi,Ie.directionalShadowMap.value=F.state.directionalShadowMap,Ie.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Ie.spotShadowMap.value=F.state.spotShadowMap,Ie.spotLightMatrix.value=F.state.spotLightMatrix,Ie.spotLightMap.value=F.state.spotLightMap,Ie.pointShadowMap.value=F.state.pointShadowMap,Ie.pointShadowMatrix.value=F.state.pointShadowMatrix),Y.currentProgram=ke,Y.uniformsList=null,ke}function hu(M){if(M.uniformsList===null){const N=M.currentProgram.getUniforms();M.uniformsList=To.seqWithValue(N.seq,M.uniforms)}return M.uniformsList}function du(M,N){const $=q.get(M);$.outputColorSpace=N.outputColorSpace,$.batching=N.batching,$.batchingColor=N.batchingColor,$.instancing=N.instancing,$.instancingColor=N.instancingColor,$.instancingMorph=N.instancingMorph,$.skinning=N.skinning,$.morphTargets=N.morphTargets,$.morphNormals=N.morphNormals,$.morphColors=N.morphColors,$.morphTargetsCount=N.morphTargetsCount,$.numClippingPlanes=N.numClippingPlanes,$.numIntersection=N.numClipIntersection,$.vertexAlphas=N.vertexAlphas,$.vertexTangents=N.vertexTangents,$.toneMapping=N.toneMapping}function Ip(M,N,$,Y,F){N.isScene!==!0&&(N=Fe),ee.resetTextureUnits();const ce=N.fog,Se=Y.isMeshStandardMaterial?N.environment:null,Re=U===null?S.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:kr,Te=(Y.isMeshStandardMaterial?ge:ie).get(Y.envMap||Se),Oe=Y.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,ke=!!$.attributes.tangent&&(!!Y.normalMap||Y.anisotropy>0),Ie=!!$.morphAttributes.position,$e=!!$.morphAttributes.normal,ot=!!$.morphAttributes.color;let yt=Ei;Y.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(yt=S.toneMapping);const pt=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,ut=pt!==void 0?pt.length:0,Ue=q.get(Y),vt=d.state.lights;if(te===!0&&(de===!0||M!==b)){const Bt=M===b&&Y.id===E;oe.setState(Y,M,Bt)}let Ye=!1;Y.version===Ue.__version?(Ue.needsLights&&Ue.lightsStateVersion!==vt.state.version||Ue.outputColorSpace!==Re||F.isBatchedMesh&&Ue.batching===!1||!F.isBatchedMesh&&Ue.batching===!0||F.isBatchedMesh&&Ue.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Ue.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Ue.instancing===!1||!F.isInstancedMesh&&Ue.instancing===!0||F.isSkinnedMesh&&Ue.skinning===!1||!F.isSkinnedMesh&&Ue.skinning===!0||F.isInstancedMesh&&Ue.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Ue.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Ue.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Ue.instancingMorph===!1&&F.morphTexture!==null||Ue.envMap!==Te||Y.fog===!0&&Ue.fog!==ce||Ue.numClippingPlanes!==void 0&&(Ue.numClippingPlanes!==oe.numPlanes||Ue.numIntersection!==oe.numIntersection)||Ue.vertexAlphas!==Oe||Ue.vertexTangents!==ke||Ue.morphTargets!==Ie||Ue.morphNormals!==$e||Ue.morphColors!==ot||Ue.toneMapping!==yt||Ue.morphTargetsCount!==ut)&&(Ye=!0):(Ye=!0,Ue.__version=Y.version);let Zt=Ue.currentProgram;Ye===!0&&(Zt=Fs(Y,N,F));let ar=!1,Jt=!1,Xr=!1;const xt=Zt.getUniforms(),an=Ue.uniforms;if(G.useProgram(Zt.program)&&(ar=!0,Jt=!0,Xr=!0),Y.id!==E&&(E=Y.id,Jt=!0),ar||b!==M){G.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),xt.setValue(v,"projectionMatrix",M.projectionMatrix),xt.setValue(v,"viewMatrix",M.matrixWorldInverse);const Xt=xt.map.cameraPosition;Xt!==void 0&&Xt.setValue(v,De.setFromMatrixPosition(M.matrixWorld)),j.logarithmicDepthBuffer&&xt.setValue(v,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(Y.isMeshPhongMaterial||Y.isMeshToonMaterial||Y.isMeshLambertMaterial||Y.isMeshBasicMaterial||Y.isMeshStandardMaterial||Y.isShaderMaterial)&&xt.setValue(v,"isOrthographic",M.isOrthographicCamera===!0),b!==M&&(b=M,Jt=!0,Xr=!0)}if(F.isSkinnedMesh){xt.setOptional(v,F,"bindMatrix"),xt.setOptional(v,F,"bindMatrixInverse");const Bt=F.skeleton;Bt&&(Bt.boneTexture===null&&Bt.computeBoneTexture(),xt.setValue(v,"boneTexture",Bt.boneTexture,ee))}F.isBatchedMesh&&(xt.setOptional(v,F,"batchingTexture"),xt.setValue(v,"batchingTexture",F._matricesTexture,ee),xt.setOptional(v,F,"batchingIdTexture"),xt.setValue(v,"batchingIdTexture",F._indirectTexture,ee),xt.setOptional(v,F,"batchingColorTexture"),F._colorsTexture!==null&&xt.setValue(v,"batchingColorTexture",F._colorsTexture,ee));const ln=$.morphAttributes;if((ln.position!==void 0||ln.normal!==void 0||ln.color!==void 0)&&ae.update(F,$,Zt),(Jt||Ue.receiveShadow!==F.receiveShadow)&&(Ue.receiveShadow=F.receiveShadow,xt.setValue(v,"receiveShadow",F.receiveShadow)),Y.isMeshGouraudMaterial&&Y.envMap!==null&&(an.envMap.value=Te,an.flipEnvMap.value=Te.isCubeTexture&&Te.isRenderTargetTexture===!1?-1:1),Y.isMeshStandardMaterial&&Y.envMap===null&&N.environment!==null&&(an.envMapIntensity.value=N.environmentIntensity),Jt&&(xt.setValue(v,"toneMappingExposure",S.toneMappingExposure),Ue.needsLights&&Lp(an,Xr),ce&&Y.fog===!0&&J.refreshFogUniforms(an,ce),J.refreshMaterialUniforms(an,Y,k,Q,d.state.transmissionRenderTarget[M.id]),To.upload(v,hu(Ue),an,ee)),Y.isShaderMaterial&&Y.uniformsNeedUpdate===!0&&(To.upload(v,hu(Ue),an,ee),Y.uniformsNeedUpdate=!1),Y.isSpriteMaterial&&xt.setValue(v,"center",F.center),xt.setValue(v,"modelViewMatrix",F.modelViewMatrix),xt.setValue(v,"normalMatrix",F.normalMatrix),xt.setValue(v,"modelMatrix",F.matrixWorld),Y.isShaderMaterial||Y.isRawShaderMaterial){const Bt=Y.uniformsGroups;for(let Xt=0,fa=Bt.length;Xt<fa;Xt++){const Di=Bt[Xt];ze.update(Di,Zt),ze.bind(Di,Zt)}}return Zt}function Lp(M,N){M.ambientLightColor.needsUpdate=N,M.lightProbe.needsUpdate=N,M.directionalLights.needsUpdate=N,M.directionalLightShadows.needsUpdate=N,M.pointLights.needsUpdate=N,M.pointLightShadows.needsUpdate=N,M.spotLights.needsUpdate=N,M.spotLightShadows.needsUpdate=N,M.rectAreaLights.needsUpdate=N,M.hemisphereLights.needsUpdate=N}function Up(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(M,N,$){const Y=q.get(M);Y.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,Y.__autoAllocateDepthBuffer===!1&&(Y.__useRenderToTexture=!1),q.get(M.texture).__webglTexture=N,q.get(M.depthTexture).__webglTexture=Y.__autoAllocateDepthBuffer?void 0:$,Y.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,N){const $=q.get(M);$.__webglFramebuffer=N,$.__useDefaultFramebuffer=N===void 0};const Np=v.createFramebuffer();this.setRenderTarget=function(M,N=0,$=0){U=M,D=N,P=$;let Y=!0,F=null,ce=!1,Se=!1;if(M){const Te=q.get(M);if(Te.__useDefaultFramebuffer!==void 0)G.bindFramebuffer(v.FRAMEBUFFER,null),Y=!1;else if(Te.__webglFramebuffer===void 0)ee.setupRenderTarget(M);else if(Te.__hasExternalTextures)ee.rebindTextures(M,q.get(M.texture).__webglTexture,q.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Ie=M.depthTexture;if(Te.__boundDepthTexture!==Ie){if(Ie!==null&&q.has(Ie)&&(M.width!==Ie.image.width||M.height!==Ie.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");ee.setupDepthRenderbuffer(M)}}const Oe=M.texture;(Oe.isData3DTexture||Oe.isDataArrayTexture||Oe.isCompressedArrayTexture)&&(Se=!0);const ke=q.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(ke[N])?F=ke[N][$]:F=ke[N],ce=!0):M.samples>0&&ee.useMultisampledRTT(M)===!1?F=q.get(M).__webglMultisampledFramebuffer:Array.isArray(ke)?F=ke[$]:F=ke,C.copy(M.viewport),O.copy(M.scissor),W=M.scissorTest}else C.copy(Ce).multiplyScalar(k).floor(),O.copy(Ne).multiplyScalar(k).floor(),W=ct;if($!==0&&(F=Np),G.bindFramebuffer(v.FRAMEBUFFER,F)&&Y&&G.drawBuffers(M,F),G.viewport(C),G.scissor(O),G.setScissorTest(W),ce){const Te=q.get(M.texture);v.framebufferTexture2D(v.FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_CUBE_MAP_POSITIVE_X+N,Te.__webglTexture,$)}else if(Se){const Te=N;for(let Oe=0;Oe<M.textures.length;Oe++){const ke=q.get(M.textures[Oe]);v.framebufferTextureLayer(v.FRAMEBUFFER,v.COLOR_ATTACHMENT0+Oe,ke.__webglTexture,$,Te)}}else if(M!==null&&$!==0){const Te=q.get(M.texture);v.framebufferTexture2D(v.FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_2D,Te.__webglTexture,$)}E=-1},this.readRenderTargetPixels=function(M,N,$,Y,F,ce,Se,Re=0){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Te=q.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Se!==void 0&&(Te=Te[Se]),Te){G.bindFramebuffer(v.FRAMEBUFFER,Te);try{const Oe=M.textures[Re],ke=Oe.format,Ie=Oe.type;if(!j.textureFormatReadable(ke)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!j.textureTypeReadable(Ie)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=M.width-Y&&$>=0&&$<=M.height-F&&(M.textures.length>1&&v.readBuffer(v.COLOR_ATTACHMENT0+Re),v.readPixels(N,$,Y,F,be.convert(ke),be.convert(Ie),ce))}finally{const Oe=U!==null?q.get(U).__webglFramebuffer:null;G.bindFramebuffer(v.FRAMEBUFFER,Oe)}}},this.readRenderTargetPixelsAsync=async function(M,N,$,Y,F,ce,Se,Re=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Te=q.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Se!==void 0&&(Te=Te[Se]),Te)if(N>=0&&N<=M.width-Y&&$>=0&&$<=M.height-F){G.bindFramebuffer(v.FRAMEBUFFER,Te);const Oe=M.textures[Re],ke=Oe.format,Ie=Oe.type;if(!j.textureFormatReadable(ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!j.textureTypeReadable(Ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const $e=v.createBuffer();v.bindBuffer(v.PIXEL_PACK_BUFFER,$e),v.bufferData(v.PIXEL_PACK_BUFFER,ce.byteLength,v.STREAM_READ),M.textures.length>1&&v.readBuffer(v.COLOR_ATTACHMENT0+Re),v.readPixels(N,$,Y,F,be.convert(ke),be.convert(Ie),0);const ot=U!==null?q.get(U).__webglFramebuffer:null;G.bindFramebuffer(v.FRAMEBUFFER,ot);const yt=v.fenceSync(v.SYNC_GPU_COMMANDS_COMPLETE,0);return v.flush(),await PS(v,yt,4),v.bindBuffer(v.PIXEL_PACK_BUFFER,$e),v.getBufferSubData(v.PIXEL_PACK_BUFFER,0,ce),v.deleteBuffer($e),v.deleteSync(yt),ce}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,N=null,$=0){const Y=Math.pow(2,-$),F=Math.floor(M.image.width*Y),ce=Math.floor(M.image.height*Y),Se=N!==null?N.x:0,Re=N!==null?N.y:0;ee.setTexture2D(M,0),v.copyTexSubImage2D(v.TEXTURE_2D,$,0,0,Se,Re,F,ce),G.unbindTexture()};const Fp=v.createFramebuffer(),Op=v.createFramebuffer();this.copyTextureToTexture=function(M,N,$=null,Y=null,F=0,ce=null){ce===null&&(F!==0?(Lr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ce=F,F=0):ce=0);let Se,Re,Te,Oe,ke,Ie,$e,ot,yt;const pt=M.isCompressedTexture?M.mipmaps[ce]:M.image;if($!==null)Se=$.max.x-$.min.x,Re=$.max.y-$.min.y,Te=$.isBox3?$.max.z-$.min.z:1,Oe=$.min.x,ke=$.min.y,Ie=$.isBox3?$.min.z:0;else{const ln=Math.pow(2,-F);Se=Math.floor(pt.width*ln),Re=Math.floor(pt.height*ln),M.isDataArrayTexture?Te=pt.depth:M.isData3DTexture?Te=Math.floor(pt.depth*ln):Te=1,Oe=0,ke=0,Ie=0}Y!==null?($e=Y.x,ot=Y.y,yt=Y.z):($e=0,ot=0,yt=0);const ut=be.convert(N.format),Ue=be.convert(N.type);let vt;N.isData3DTexture?(ee.setTexture3D(N,0),vt=v.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(ee.setTexture2DArray(N,0),vt=v.TEXTURE_2D_ARRAY):(ee.setTexture2D(N,0),vt=v.TEXTURE_2D),v.pixelStorei(v.UNPACK_FLIP_Y_WEBGL,N.flipY),v.pixelStorei(v.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),v.pixelStorei(v.UNPACK_ALIGNMENT,N.unpackAlignment);const Ye=v.getParameter(v.UNPACK_ROW_LENGTH),Zt=v.getParameter(v.UNPACK_IMAGE_HEIGHT),ar=v.getParameter(v.UNPACK_SKIP_PIXELS),Jt=v.getParameter(v.UNPACK_SKIP_ROWS),Xr=v.getParameter(v.UNPACK_SKIP_IMAGES);v.pixelStorei(v.UNPACK_ROW_LENGTH,pt.width),v.pixelStorei(v.UNPACK_IMAGE_HEIGHT,pt.height),v.pixelStorei(v.UNPACK_SKIP_PIXELS,Oe),v.pixelStorei(v.UNPACK_SKIP_ROWS,ke),v.pixelStorei(v.UNPACK_SKIP_IMAGES,Ie);const xt=M.isDataArrayTexture||M.isData3DTexture,an=N.isDataArrayTexture||N.isData3DTexture;if(M.isDepthTexture){const ln=q.get(M),Bt=q.get(N),Xt=q.get(ln.__renderTarget),fa=q.get(Bt.__renderTarget);G.bindFramebuffer(v.READ_FRAMEBUFFER,Xt.__webglFramebuffer),G.bindFramebuffer(v.DRAW_FRAMEBUFFER,fa.__webglFramebuffer);for(let Di=0;Di<Te;Di++)xt&&(v.framebufferTextureLayer(v.READ_FRAMEBUFFER,v.COLOR_ATTACHMENT0,q.get(M).__webglTexture,F,Ie+Di),v.framebufferTextureLayer(v.DRAW_FRAMEBUFFER,v.COLOR_ATTACHMENT0,q.get(N).__webglTexture,ce,yt+Di)),v.blitFramebuffer(Oe,ke,Se,Re,$e,ot,Se,Re,v.DEPTH_BUFFER_BIT,v.NEAREST);G.bindFramebuffer(v.READ_FRAMEBUFFER,null),G.bindFramebuffer(v.DRAW_FRAMEBUFFER,null)}else if(F!==0||M.isRenderTargetTexture||q.has(M)){const ln=q.get(M),Bt=q.get(N);G.bindFramebuffer(v.READ_FRAMEBUFFER,Fp),G.bindFramebuffer(v.DRAW_FRAMEBUFFER,Op);for(let Xt=0;Xt<Te;Xt++)xt?v.framebufferTextureLayer(v.READ_FRAMEBUFFER,v.COLOR_ATTACHMENT0,ln.__webglTexture,F,Ie+Xt):v.framebufferTexture2D(v.READ_FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_2D,ln.__webglTexture,F),an?v.framebufferTextureLayer(v.DRAW_FRAMEBUFFER,v.COLOR_ATTACHMENT0,Bt.__webglTexture,ce,yt+Xt):v.framebufferTexture2D(v.DRAW_FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_2D,Bt.__webglTexture,ce),F!==0?v.blitFramebuffer(Oe,ke,Se,Re,$e,ot,Se,Re,v.COLOR_BUFFER_BIT,v.NEAREST):an?v.copyTexSubImage3D(vt,ce,$e,ot,yt+Xt,Oe,ke,Se,Re):v.copyTexSubImage2D(vt,ce,$e,ot,Oe,ke,Se,Re);G.bindFramebuffer(v.READ_FRAMEBUFFER,null),G.bindFramebuffer(v.DRAW_FRAMEBUFFER,null)}else an?M.isDataTexture||M.isData3DTexture?v.texSubImage3D(vt,ce,$e,ot,yt,Se,Re,Te,ut,Ue,pt.data):N.isCompressedArrayTexture?v.compressedTexSubImage3D(vt,ce,$e,ot,yt,Se,Re,Te,ut,pt.data):v.texSubImage3D(vt,ce,$e,ot,yt,Se,Re,Te,ut,Ue,pt):M.isDataTexture?v.texSubImage2D(v.TEXTURE_2D,ce,$e,ot,Se,Re,ut,Ue,pt.data):M.isCompressedTexture?v.compressedTexSubImage2D(v.TEXTURE_2D,ce,$e,ot,pt.width,pt.height,ut,pt.data):v.texSubImage2D(v.TEXTURE_2D,ce,$e,ot,Se,Re,ut,Ue,pt);v.pixelStorei(v.UNPACK_ROW_LENGTH,Ye),v.pixelStorei(v.UNPACK_IMAGE_HEIGHT,Zt),v.pixelStorei(v.UNPACK_SKIP_PIXELS,ar),v.pixelStorei(v.UNPACK_SKIP_ROWS,Jt),v.pixelStorei(v.UNPACK_SKIP_IMAGES,Xr),ce===0&&N.generateMipmaps&&v.generateMipmap(vt),G.unbindTexture()},this.copyTextureToTexture3D=function(M,N,$=null,Y=null,F=0){return Lr('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(M,N,$,Y,F)},this.initRenderTarget=function(M){q.get(M).__webglFramebuffer===void 0&&ee.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?ee.setTextureCube(M,0):M.isData3DTexture?ee.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?ee.setTexture2DArray(M,0):ee.setTexture2D(M,0),G.unbindTexture()},this.resetState=function(){D=0,P=0,U=null,G.reset(),me.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Rn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=je._getDrawingBufferColorSpace(e),t.unpackColorSpace=je._getUnpackColorSpace()}}const{lerp:Xi}=CS,It=[151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,8,99,37,240,21,10,23,190,6,148,247,120,234,75,0,26,197,62,94,252,219,203,117,35,11,32,57,177,33,88,237,149,56,87,174,20,125,136,171,168,68,175,74,165,71,134,139,48,27,166,77,146,158,231,83,111,229,122,60,211,133,230,220,105,92,41,55,46,245,40,244,102,143,54,65,25,63,161,1,216,80,73,209,76,132,187,208,89,18,169,200,196,135,130,116,188,159,86,164,100,109,198,173,186,3,64,52,217,226,250,124,123,5,202,38,147,118,126,255,82,85,212,207,206,59,227,47,16,58,17,182,189,28,42,223,183,170,213,119,248,152,2,44,154,163,70,221,153,101,155,167,43,172,9,129,22,39,253,19,98,108,110,79,113,224,232,178,185,112,104,218,246,97,228,251,34,242,193,238,210,144,12,191,179,162,241,81,51,145,235,249,14,239,107,49,192,214,31,181,199,106,157,184,84,204,176,115,121,50,45,127,4,150,254,138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180];for(let n=0;n<256;n++)It[256+n]=It[n];function ll(n){return n*n*n*(n*(n*6-15)+10)}function pi(n,e,t,i){const r=n&15,s=r<8?e:t,o=r<4?t:r==12||r==14?e:i;return((r&1)==0?s:-s)+((r&2)==0?o:-o)}class aA{noise(e,t,i){const r=Math.floor(e),s=Math.floor(t),o=Math.floor(i),a=r&255,l=s&255,c=o&255;e-=r,t-=s,i-=o;const u=e-1,f=t-1,h=i-1,p=ll(e),_=ll(t),x=ll(i),m=It[a]+l,d=It[m]+c,w=It[m+1]+c,T=It[a+1]+l,S=It[T]+c,R=It[T+1]+c;return Xi(Xi(Xi(pi(It[d],e,t,i),pi(It[S],u,t,i),p),Xi(pi(It[w],e,f,i),pi(It[R],u,f,i),p),_),Xi(Xi(pi(It[d+1],e,t,h),pi(It[S+1],u,t,h),p),Xi(pi(It[w+1],e,f,h),pi(It[R+1],u,f,h),p),_),x)}}const lA={key:0,class:"absolute inset-0 flex items-center justify-center bg-black text-white z-50"},cA=7,uA={__name:"Thorus",setup(n){let e,t,i,r;const s=new aA,o=[],a=Ht(!1);let l,c;const u=Ht(!1);let f=!0;Ci(()=>{h(),x(),window.addEventListener("resize",d)});function h(){e=new ny,t=new nn(75,window.innerWidth/window.innerHeight,.1,100),t.position.z=10,e.add(new gy(16777215,.5)),i=new oA({antialias:!0}),i.setSize(window.innerWidth,window.innerHeight),document.getElementById("out").appendChild(i.domElement),_();const w=new py(16777215,1);w.position.set(50,50,50),e.add(w),c=new yy,t.add(c),l=new My(c),new _y().load("Canceinterlude.flac",S=>{l.setBuffer(S),l.setLoop(!0),l.setVolume(.5),r=new Ey(l,32),a.value=!0},void 0,S=>console.error("Audio load failed",S))}function p(){a.value&&(u.value?(l.pause(),u.value=!1,f=!0,x()):(l.play(),u.value=!0,f=!1,m()))}function _(){const w=`
  varying vec2 vUv;
  varying float vWave;
  varying vec3 vNormal;
  varying vec3 vPosition;
